...
describe("case-converter transform", () => {
  it("converts to camelCase", () => {
    expect(caseConverter.transform("hello world", { style: "camel" })).toBe(
      "helloWorld",
    );
  });

  it("converts to snake_case", () => {
    expect(caseConverter.transform("Hello World", { style: "snake" })).toBe(
      "hello_world",
    );
  });

  it("converts to kebab-case", () => {
    expect(caseConverter.transform("Hello World", { style: "kebab" })).toBe(
      "hello-world",
    );
  });

  it("converts to PascalCase", () => {
    expect(caseConverter.transform("hello world", { style: "pascal" })).toBe(
      "HelloWorld",
    );
  });
  ...
  it("converts to CONSTANT_CASE", () => {
    expect(caseConverter.transform("hello world", { style: "constant" })).toBe(
      "HELLO_WORLD",
    );
  });
