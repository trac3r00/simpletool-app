...
describe("url-encode transform", () => {
  it("encodes text", () => {
    expect(urlEncode.transform("hello world", { mode: "encode" })).toBe(
      "hello%20world",
    );
  });

  it("decodes text", () => {
    expect(urlEncode.transform("hello%20world", { mode: "decode" })).toBe(
      "hello world",
    );
  });

  it("encodes special characters", () => {
    expect(urlEncode.transform("a=1&b=2", { mode: "encode" })).toBe(
      "a%3D1%26b%3D2",
    );
  });
