...
export default {
  nav: {
    home: "SimpleTool",
    search: "Tìm kiếm... (Cmd+K)",
    searchTools: "Tìm công cụ...",
    searchNavigate: "di chuyển",
    searchSelect: "chọn",
    searchClose: "đóng",
  ...
  footer: {
    ...
    github: "GitHub",
    tagline: "Công cụ web ưu tiên quyền riêng tư cho nhà phát triển.",
    ...
    privacyNote:
      "Được xây dựng với ưu tiên quyền riêng tư. Mọi công cụ chạy phía máy khách.",
  },
  common: {
    copy: "Sao chép",
    copied: "Đã sao chép",
  ...
  home: {
    heroTitle: "Công cụ miễn phí cho nhà phát triển",
    heroLine1:
  ...
  tools: {
    "json-formatter": {
      ...
      edu: {
        heading1: "JSON là gì?",
        p1: "<p>JSON (JavaScript Object Notation) là định dạng trao đổi dữ liệu nhẹ, dễ đọc và viết cho người dùng, đồng thời dễ phân tích và tạo ra cho máy tính. Nó dựa trên một tập hợp con của Chuẩn ngôn ngữ lập trình JavaScript. JSON là định dạng văn bản hoàn toàn độc lập với ngôn ngữ nhưng sử dụng các quy ước quen thuộc với lập trình viên các ngôn ngữ họ C.</p><p>Những đặc tính này khiến JSON trở thành ngôn ngữ trao đổi dữ liệu lý tưởng cho ứng dụng web, API và tệp cấu hình. Nó đã trở thành tiêu chuẩn thực tế cho trao đổi dữ liệu trên web, thay thế rộng rãi XML nhờ kích thước nhỏ hơn và hiệu suất tốt hơn.</p>",
        heading2: "Cách sử dụng công cụ này",
        p2: "<ol><li>Dán dữ liệu JSON thô hoặc lộn xộn của bạn vào trình soạn thảo bên trái.</li><li>Nhấp Format để làm đẹp mã với thụt lề đúng và tô sáng cú pháp.</li><li>Hoặc dùng Minify để xóa tất cả khoảng trắng cho mục đích sản xuất.</li><li>Kiểm tra chỉ báo Trạng thái để đảm bảo JSON của bạn hợp lệ; nếu có lỗi, công cụ sẽ làm nổi bật đúng dòng đó.</li><li>Nhấp Copy để lưu kết quả đã định dạng vào clipboard hoặc Clear để bắt đầu lại.</li></ol>",
        heading3: "Các trường hợp sử dụng phổ biến",
        p3: "<ul><li><strong>Gỡ lỗi API:</strong> Nhanh chóng định dạng các phản hồi JSON khó đọc từ REST API để kiểm tra cấu trúc dữ liệu.</li><li><strong>Xác thực cấu hình:</strong> Đảm bảo các tệp <code>package.json</code>, <code>tsconfig.json</code> hoặc các tệp cấu hình khác của bạn đúng cú pháp.</li><li><strong>Chuẩn bị dữ liệu:</strong> Rút gọn dữ liệu JSON trước khi nhúng vào mã hoặc gửi qua mạng để tiết kiệm băng thông.</li><li><strong>Học tập &amp; Tài liệu:</strong> Sử dụng đầu ra đã định dạng để tạo ví dụ rõ ràng cho tài liệu kỹ thuật hoặc hướng dẫn.</li></ul>",
        heading4: "Mẹo chuyên nghiệp",
        p4: "<ul><li>Dùng nút Validate nếu bạn chỉ muốn kiểm tra lỗi cú pháp mà không thay đổi định dạng đầu vào.</li><li>Chú ý đến thống kê Độ sâu tối đa để phát hiện các cấu trúc quá phức tạp hoặc lồng nhau sâu có thể gây vấn đề hiệu suất.</li><li>Luôn dùng dấu ngoặc kép cho khóa và giá trị chuỗi, vì dấu ngoặc đơn không hợp lệ trong JSON chuẩn.</li></ul>",
      },
    },
    "jwt-decoder": {
    ...
    "password-generator": {
      ...
      edu: {
        ...
        p1: "<p>Mật khẩu an toàn là tuyến phòng thủ đầu tiên của bạn chống lại truy cập trái phép. Trong thời đại tính toán tốc độ cao hiện nay, bảo mật được định nghĩa bởi <strong>entropy</strong> — thước đo tính ngẫu nhiên và khó đoán của một chuỗi ký tự. Mật khẩu mạnh phải dài (ít nhất 16 ký tự), duy nhất cho mỗi tài khoản và bao gồm nhiều loại ký tự khác nhau như chữ hoa, chữ thường, số và ký tự đặc biệt.</p><p>Tránh sử dụng thông tin cá nhân như ngày sinh, tên thú cưng hoặc các từ thông thường trong từ điển. Ngay cả những thay thế có vẻ phức tạp như P@ssw0rd123 cũng dễ dàng bị phá vỡ bởi các công cụ brute-force hiện đại sử dụng từ điển khổng lồ các mẫu phổ biến.</p>",
        heading2: "Cách sử dụng công cụ này",
        p2: "<ol><li><strong>Chọn chế độ:</strong> Chọn giữa Mật khẩu, Tên đăng nhập, Cụm mật khẩu hoặc Bí danh email tùy theo nhu cầu.</li><li><strong>Điều chỉnh độ dài:</strong> Dùng thanh trượt để đặt độ dài mong muốn. Với mật khẩu, 16+ ký tự được khuyến nghị cho bảo mật cao.</li><li><strong>Cấu hình tùy chọn:</strong> Bật/tắt các bộ ký tự (ký tự đặc biệt, số, v.v.) hoặc kiểu (dễ đọc vs. an toàn).</li><li><strong>Tạo:</strong> Nhấp nút Tạo để tạo thông tin đăng nhập độc đáo của bạn.</li><li><strong>Sao chép:</strong> Dùng biểu tượng sao chép để chuyển kết quả an toàn vào clipboard hoặc trình quản lý mật khẩu.</li></ol>",
        heading3: "Các trường hợp sử dụng phổ biến",
        p3: "<ul><li><strong>Bảo mật tài khoản:</strong> Tạo mật khẩu độc đáo, entropy cao cho mỗi dịch vụ trực tuyến bạn sử dụng.</li><li><strong>Quản trị hệ thống:</strong> Tạo mật khẩu tạm thời an toàn cho người dùng mới hoặc tài khoản dịch vụ.</li><li><strong>Bảo vệ quyền riêng tư:</strong> Dùng Plus Alias (vd: nguoidung+dichvu@domain.com) để theo dõi dịch vụ nào bán dữ liệu của bạn hoặc lọc spam.</li><li><strong>Bảo mật dễ nhớ:</strong> Dùng trình tạo Cụm mật khẩu cho mật khẩu chính cần nhập tay nhưng vẫn chống phá khóa.</li></ul>",
        heading4: "Mẹo chuyên nghiệp",
        p4: "<ul><li><strong>Dùng trình quản lý mật khẩu:</strong> Đừng cố gắng ghi nhớ mật khẩu phức tạp. Dùng công cụ này để tạo và lưu chúng trong trình quản lý uy tín như Bitwarden, 1Password hoặc KeePassXC.</li><li><strong>Entropy hơn Độ phức tạp:</strong> Độ dài thường quan trọng hơn sự đa dạng ký tự. Mật khẩu 20 ký tự thường khó phá hơn mật khẩu 8 ký tự phức tạp.</li><li><strong>Thay đổi sau vi phạm:</strong> Nếu dịch vụ bạn dùng bị xâm phạm, hãy dùng bộ tạo này để tạo mật khẩu hoàn toàn mới ngay lập tức.</li></ul>",
        heading5: "Điều gì làm cho mật khẩu trở nên an toàn?",
        p5: "<p>Mật khẩu an toàn là tuyến phòng thủ đầu tiên của bạn. <strong>Entropy</strong> là thước đo tính ngẫu nhiên của mật khẩu. Mật khẩu mạnh phải dài, độc đáo và đa dạng ký tự.</p>",
        heading6: "Giải thích về Entropy",
        p6: "<p>Entropy là thước đo tính ngẫu nhiên và khó đoán của mật khẩu, thường được biểu thị bằng bit. Entropy càng cao, mật khẩu càng mạnh. Bộ tạo của chúng tôi tính toán entropy theo thời gian thực để cung cấp đánh giá khách quan về độ mạnh mật khẩu của bạn.</p>",
        heading7: "Thực hành tốt nhất",
        p7: "<ul><li><strong>Không bao giờ dùng lại mật khẩu:</strong> Dùng mật khẩu độc đáo cho mỗi tài khoản.</li><li><strong>Dùng trình quản lý mật khẩu:</strong> Con người không thể nhớ hàng chục mật khẩu phức tạp, hãy dùng trình quản lý uy tín.</li><li><strong>Bật MFA:</strong> Xác thực đa yếu tố thêm lớp bảo mật thứ hai quan trọng.</li><li><strong>Tránh thông tin cá nhân:</strong> Không bao giờ dùng tên, ngày sinh hoặc từ thông thường.</li></ul>",
        heading8: "Mẹo chuyên nghiệp",
        p8: "<ul><li>Dùng chế độ Cụm mật khẩu cho tài khoản cần nhập tay; dễ nhớ hơn nhưng vẫn rất an toàn.</li><li>Để bảo mật tối đa, tạo mật khẩu dài nhất được phép bởi dịch vụ (thường 64 hoặc 128 ký tự).</li><li>Thường xuyên kiểm tra mật khẩu đã lưu bằng tính năng kiểm tra bảo mật tích hợp của trình quản lý.</li><li>Cân nhắc dùng Plus Alias (vd: nguoidung+dichvu@gmail.com) để theo dõi dịch vụ nào bán dữ liệu của bạn.</li></ul>",
      },
    },
    "hash-calculator": {
      name: "Máy Tính Hash",
    ...
    "cidr-calculator": {
      ...
      cheatsheet: {
        ...
        h1: "Dải địa chỉ riêng tư (RFC 1918)",
        c0: '<table> <tr><th>CIDR</th><th data-i18n="tools.cidr-calculator.ui.th18">Mặt nạ subnet</th><th data-i18n="tools.cidr-calculator.ui.th19">Hosts</th><th data-i18n="tools.cidr-calculator.ui.th20">Trường hợp sử dụng</th></tr> <tr><td><code>/32</code></td><td>255.255.255.255</td><td>1</td><td>Một host</td></tr> <tr><td><code>/24</code></td><td>255.255.255.0</td><td>254</td><td>Mạng nhỏ</td></tr> <tr><td><code>/16</code></td><td>255.255.0.0</td><td>65.534</td><td>Mạng trung bình</td></tr> <tr><td><code>/8</code></td><td>255.0.0.0</td><td>16M+</td><td>Mạng lớn</td></tr> </table>',
        c1: '<table> <tr><th data-i18n="tools.cidr-calculator.ui.th13">Dải</th><th>CIDR</th><th data-i18n="tools.cidr-calculator.ui.th21">Lớp</th></tr> <tr><td>10.0.0.0 – 10.255.255.255</td><td><code>10.0.0.0/8</code></td><td>A</td></tr> <tr><td>172.16.0.0 – 172.31.255.255</td><td><code>172.16.0.0/12</code></td><td>B</td></tr> <tr><td>192.168.0.0 – 192.168.255.255</td><td><code>192.168.0.0/16</code></td><td>C</td></tr> </table>',
      },
    },
    "dns-reference": {
    ...
    "cron-builder": {
      ...
      cheatsheet: {
        title: "Tham chiếu cú pháp Cron",
        h0: "Thứ tự các trường",
        h1: "Ký tự đặc biệt",
        h2: "Ví dụ phổ biến",
        c0: '<table> <tr><th data-i18n="tools.cron-builder.ui.th0">Vị trí</th><th data-i18n="tools.cron-builder.ui.th1">Trường</th><th data-i18n="tools.cron-builder.ui.th2">Phạm vi</th></tr> <tr><td>1</td><td>Phút</td><td>0–59</td></tr> <tr><td>2</td><td>Giờ</td><td>0–23</td></tr> <tr><td>3</td><td>Ngày trong tháng</td><td>1–31</td></tr> <tr><td>4</td><td>Tháng</td><td>1–12</td></tr> <tr><td>5</td><td>Ngày trong tuần</td><td>0–7 (0,7 = CN)</td></tr> </table>',
        c1: '<table> <tr><th data-i18n="tools.cron-builder.ui.th3">Ký tự</th><th data-i18n="tools.cron-builder.ui.th4">Ý nghĩa</th><th data-i18n="tools.cron-builder.ui.th5">Ví dụ</th></tr> <tr><td><code>*</code></td><td>Bất kỳ giá trị</td><td>Mỗi phút</td></tr> <tr><td><code>,</code></td><td>Danh sách</td><td><code>1,15</code> (ngày 1 và 15)</td></tr> <tr><td><code>-</code></td><td>Phạm vi</td><td><code>1-5</code> (Th2–Th6)</td></tr> <tr><td><code>/</code></td><td>Bước</td><td><code>*/5</code> (mỗi 5 phút)</td></tr> </table>',
        c2: '<table> <tr><th data-i18n="tools.cron-builder.ui.th6">Biểu thức</th><th data-i18n="tools.cron-builder.ui.th7">Mô tả</th></tr> <tr><td><code>0 * * * *</code></td><td>Mỗi giờ</td></tr> <tr><td><code>0 0 * * *</code></td><td>Hàng ngày lúc nửa đêm</td></tr> <tr><td><code>0 0 * * 1</code></td><td>Mỗi thứ Hai</td></tr> <tr><td><code>*/5 * * * *</code></td><td>Mỗi 5 phút</td></tr> <tr><td><code>0 9-17 * * 1-5</code></td><td>Hàng giờ từ 9h–17h các ngày làm việc</td></tr> </table>',
      },
    },
    "ssh-key-generator": {
    ...
    "color-converter": {
      ...
      edu: {
        ...
        heading3: "Các trường hợp sử dụng phổ biến",
        heading4: "Mẹo chuyên nghiệp",
        p1: "<p>Mô hình màu sắc là các hệ thống toán học để biểu diễn màu sắc. <strong>HEX</strong> (Thập lục phân) là mã 6 chữ số dùng trong HTML và CSS, đại diện cho các thành phần Đỏ, Xanh lá và Xanh dương. <strong>RGB</strong> (Đỏ, Xanh lá, Xanh dương) sử dụng giá trị thập phân từ 0 đến 255 cho mỗi kênh, thường dùng trong hình ảnh kỹ thuật số.</p><p><strong>HSL</strong> (Sắc độ, Độ bão hòa, Độ sáng) trực quan hơn với con người, vì nó mô tả màu sắc theo màu cơ bản (Hue), cường độ (Saturation) và độ sáng (Lightness). Hiểu các mô hình này giúp chọn đúng định dạng cho nhu cầu thiết kế và phát triển, đảm bảo tính nhất quán trên các nền tảng và thiết bị khác nhau.</p>",
        p2: "<ol><li>Dùng bộ chọn màu trực quan để chọn màu bằng cách kéo con trỏ trong ô vuông độ bão hòa/độ sáng và thanh trượt sắc độ.</li><li>Hoặc nhập giá trị cụ thể vào trường &laquo;Nhập thủ công&raquo; (hỗ trợ định dạng #hex, rgb hoặc hsl).</li><li>Quan sát hộp &laquo;Xem trước&raquo; để thấy màu đã chọn theo thời gian thực.</li><li>Xem các giá trị đã chuyển đổi trong các thẻ HEX, RGB, HSL và HSV bên dưới.</li><li>Nhấp vào biểu tượng &laquo;Sao chép&raquo; trên bất kỳ thẻ nào để lưu định dạng đó vào clipboard.</li></ol>",
        p3: "<ul><li><strong>Thiết kế web:</strong> Chuyển đổi màu từ công cụ thiết kế (thường RGB/HSL) sang mã HEX để dùng trong stylesheet CSS.</li><li><strong>Nhất quán thương hiệu:</strong> Đảm bảo màu thương hiệu được thể hiện chính xác trên các định dạng kỹ thuật số và phương tiện khác nhau.</li><li><strong>Phát triển UI:</strong> Nhanh chóng tạo các biến thể sáng hơn hoặc tối hơn của màu cơ bản bằng cách điều chỉnh giá trị Lightness trong HSL.</li><li><strong>Kiểm tra khả năng tiếp cận:</strong> Dùng xem trước để kiểm tra xem màu đã chọn có đủ độ tương phản cho văn bản có thể đọc và các phần tử UI không.</li></ul>",
        p4: "<ul><li>Dùng HSL khi thiết kế các thành phần UI như nút, vì dễ dàng tạo trạng thái hover bằng cách điều chỉnh giá trị lightness.</li><li>Khi làm việc với độ trong suốt trong CSS, ưu tiên <code>rgba()</code> hoặc <code>hsla()</code> để dễ đọc và kiểm soát kênh alpha tốt hơn.</li><li>Luôn kiểm tra tỷ lệ tương phản màu sắc để đảm bảo thiết kế của bạn dễ tiếp cận với người dùng có khiếm khuyết thị giác.</li></ul>",
      },
    },
    "unit-converter": {
    ...
    "mock-data-generator": {
      ...
      edu: {
        ...
        p1: "<p>Dữ liệu giả lập là thông tin tổng hợp bắt chước dữ liệu thực mà không chứa bất kỳ thông tin nhạy cảm hoặc thông tin cá nhân có thể nhận dạng (PII). Nó rất quan trọng với các nhà phát triển và kiểm thử viên cần tập dữ liệu thực tế để xây dựng và xác thực ứng dụng mà không gây rủi ro vi phạm dữ liệu hay vi phạm quy định quyền riêng tư như GDPR hay CCPA. Bằng cách sử dụng dữ liệu giả lập, bạn có thể mô phỏng nhiều tình huống khác nhau, đảm bảo phần mềm xử lý mọi loại đầu vào đúng cách.</p>",
    ...
    caffeinate: {
      name: "Giữ Màn Hình Sáng",
      desc: "Ngăn màn hình tắt.",
      ui: {
