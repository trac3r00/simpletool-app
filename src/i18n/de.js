...
export default {
  ...
  footer: {
    ...
    faq: "FAQ",
    github: "GitHub",
    tagline: "Datenschutzorientierte Web-Tools für Entwickler.",
    ...
    privacyNote:
      "Mit Datenschutz im Fokus entwickelt. Alle Tools laufen clientseitig.",
  },
  common: {
    copy: "Kopieren",
    copied: "Kopiert",
  ...
  home: {
    heroTitle: "Kostenlose Online-Entwicklertools",
    heroLine1:
    ...
    cat: {
      ...
      security: "🛡️ Sicherheit & Kryptografie",
      network: "🌐 Netzwerk & Web",
  ...
  tools: {
    "json-formatter": {
      ...
      edu: {
        heading1: "Was ist JSON?",
        p1: "<p>JSON (JavaScript Object Notation) ist ein leichtgewichtiges Datenaustauschformat, das für Menschen leicht zu lesen und zu schreiben sowie für Maschinen leicht zu parsen und zu generieren ist. Es basiert auf einer Teilmenge des JavaScript-Programmierstandards. JSON ist ein textbasiertes Format, das vollständig sprachunabhängig ist, aber Konventionen verwendet, die Programmierern der C-Sprachfamilie vertraut sind.</p><p>Diese Eigenschaften machen JSON zu einer idealen Datenaustauschsprache für Webanwendungen, APIs und Konfigurationsdateien. Es hat sich zum De-facto-Standard für den Datenaustausch im Web entwickelt und XML weitgehend aufgrund seines kleineren Datenvolumens und besserer Performance verdrängt.</p>",
        heading2: "So verwenden Sie dieses Tool",
        p2: "<ol><li>Fügen Sie Ihre rohen oder unformatierten JSON-Daten in den linken Editor ein.</li><li>Klicken Sie auf Format, um den Code mit korrekter Einrückung und Syntaxhervorhebung zu verschönern.</li><li>Alternativ verwenden Sie Minify, um alle Leerzeichen für den Produktionseinsatz zu entfernen.</li><li>Prüfen Sie die Statusanzeige, um sicherzustellen, dass Ihr JSON gültig ist; bei einem Fehler wird die genaue Zeile hervorgehoben.</li><li>Klicken Sie auf Copy, um das formatierte Ergebnis in die Zwischenablage zu kopieren, oder auf Clear, um neu zu beginnen.</li></ol>",
        heading3: "Häufige Anwendungsfälle",
        p3: "<ul><li><strong>API-Debugging:</strong> Unleserliche JSON-Antworten von REST-APIs schnell formatieren, um Datenstrukturen zu untersuchen.</li><li><strong>Konfigurationsvalidierung:</strong> Stellen Sie sicher, dass Ihre <code>package.json</code>, <code>tsconfig.json</code> oder andere Konfigurationsdateien syntaktisch korrekt sind.</li><li><strong>Datenvorbereitung:</strong> JSON-Daten vor der Einbettung in Code oder der Übertragung über ein Netzwerk minimieren, um Bandbreite zu sparen.</li><li><strong>Lernen &amp; Dokumentation:</strong> Die formatierte Ausgabe verwenden, um klare Beispiele für technische Dokumentation oder Tutorials zu erstellen.</li></ul>",
        heading4: "Profi-Tipps",
        p4: "<ul><li>Verwenden Sie die Validate-Schaltfläche, wenn Sie nur auf Syntaxfehler prüfen möchten, ohne die Formatierung Ihrer Eingabe zu ändern.</li><li>Achten Sie auf die Max-Tiefe-Statistik, um übermäßig komplexe oder tief verschachtelte Strukturen zu erkennen, die Leistungsprobleme verursachen könnten.</li><li>Verwenden Sie immer doppelte Anführungszeichen für Schlüssel und Zeichenkettenwerte, da einfache Anführungszeichen in Standard-JSON ungültig sind.</li></ul>",
      },
    },
    "jwt-decoder": {
      name: "JWT-Inspektor",
    ...
    "password-generator": {
      ...
      edu: {
        ...
        p1: "<p>Ein sicheres Passwort ist Ihre erste Verteidigungslinie gegen unbefugten Zugriff. Im modernen Zeitalter der Hochgeschwindigkeitsrechner wird Sicherheit durch <strong>Entropie</strong> definiert – das Maß für Zufälligkeit und Unvorhersehbarkeit in einer Zeichenkette. Ein starkes Passwort sollte lang sein (mindestens 16 Zeichen), für jedes Konto einzigartig und aus einer vielfältigen Mischung von Zeichentypen bestehen, einschließlich Groß- und Kleinbuchstaben, Zahlen und Symbolen.</p><p>Vermeiden Sie die Verwendung persönlicher Informationen wie Geburtstage, Haustiernamen oder häufige Wörter aus dem Wörterbuch. Selbst komplex wirkende Ersetzungen wie P@ssw0rd123 werden von modernen Brute-Force-Tools leicht geknackt, die umfangreiche Wörterbücher mit gängigen Mustern verwenden.</p>",
        heading2: "So verwenden Sie dieses Tool",
        p2: "<ol><li><strong>Modus wählen:</strong> Wählen Sie je nach Bedarf zwischen Passwort, Benutzername, Passphrase oder E-Mail-Alias.</li><li><strong>Länge anpassen:</strong> Verwenden Sie den Schieberegler, um die gewünschte Länge einzustellen. Für Passwörter werden 16+ Zeichen für hohe Sicherheit empfohlen.</li><li><strong>Optionen konfigurieren:</strong> Zeichensätze (Symbole, Zahlen usw.) oder Stile (lesbar vs. sicher) aktivieren oder deaktivieren.</li><li><strong>Generieren:</strong> Klicken Sie auf Generieren, um Ihr einzigartiges Anmeldedaten zu erstellen.</li><li><strong>Kopieren:</strong> Verwenden Sie das Kopiersymbol, um das Ergebnis sicher in die Zwischenablage oder Ihren Passwortmanager zu übertragen.</li></ol>",
        heading3: "Häufige Anwendungsfälle",
        p3: "<ul><li><strong>Kontosicherheit:</strong> Einzigartige, hochentropische Passwörter für jeden Online-Dienst generieren.</li><li><strong>Systemadministration:</strong> Sichere temporäre Passwörter für neue Benutzer oder Dienstkonten erstellen.</li><li><strong>Datenschutz:</strong> Plus-Aliase (z.B. benutzer+dienst@domain.com) verwenden, um zu verfolgen, welche Dienste Ihre Daten verkaufen oder Spam filtern.</li><li><strong>Einprägsame Sicherheit:</strong> Den Passphrase-Generator für Master-Passwörter verwenden, die manuell eingegeben werden müssen, aber trotzdem knacksicher sind.</li></ul>",
        heading4: "Profi-Tipps",
        p4: "<ul><li><strong>Passwortmanager verwenden:</strong> Versuchen Sie nie, komplexe Passwörter auswendig zu lernen. Generieren Sie sie mit diesem Tool und speichern Sie sie in einem seriösen Passwortmanager wie Bitwarden, 1Password oder KeePassXC.</li><li><strong>Entropie vor Komplexität:</strong> Länge ist oft wichtiger als Zeichenvielfalt. Ein 20-Zeichen-Passwort aus Kleinbuchstaben ist oft schwerer zu knacken als ein 8-Zeichen-Passwort mit Sonderzeichen.</li><li><strong>Nach Datenpanne wechseln:</strong> Wenn ein von Ihnen genutzter Dienst kompromittiert wurde, erstellen Sie sofort ein völlig neues, unabhängiges Passwort.</li></ul>",
        heading5: "Was macht ein Passwort sicher?",
        p5: "<p>Ein sicheres Passwort ist Ihre erste Verteidigungslinie gegen unbefugten Zugriff. Im modernen Zeitalter der Hochgeschwindigkeitsrechner wird Sicherheit durch <strong>Entropie</strong> definiert – das Maß für Zufälligkeit und Unvorhersehbarkeit in einer Zeichenkette. Ein starkes Passwort sollte lang sein (mindestens 16 Zeichen), für jedes Konto einzigartig und aus einer vielfältigen Mischung von Zeichentypen bestehen.</p><p>Vermeiden Sie die Verwendung persönlicher Informationen wie Geburtstage, Haustiernamen oder häufige Wörter aus dem Wörterbuch. Selbst komplex wirkende Ersetzungen wie P@ssw0rd123 werden von modernen Brute-Force-Tools leicht geknackt.</p>",
        heading6: "Entropie erklärt",
        p6: "<p>Entropie ist ein Maß für die Zufälligkeit und Unvorhersehbarkeit eines Passworts, typischerweise in Bits ausgedrückt. Je höher die Entropie, desto stärker das Passwort. Unser Generator berechnet die Entropie in Echtzeit, um Ihnen eine objektive Messung Ihrer Passwortstärke zu geben. Ein Passwort mit über 100 Bit Entropie gilt als außergewöhnlich stark.</p>",
        heading7: "Best Practices",
        p7: "<ul><li><strong>Passwörter nie wiederverwenden:</strong> Verwenden Sie für jedes Konto ein einzigartiges Passwort.</li><li><strong>Passwortmanager verwenden:</strong> Da Menschen sich nicht Dutzende komplexer Passwörter merken können, verwenden Sie einen seriösen Passwortmanager.</li><li><strong>MFA aktivieren:</strong> Multi-Faktor-Authentifizierung fügt eine kritische zweite Sicherheitsebene hinzu.</li><li><strong>Persönliche Infos vermeiden:</strong> Fügen Sie niemals Namen, Geburtstage oder häufige Wörter ein.</li></ul>",
        heading8: "Profi-Tipps",
        p8: "<ul><li>Verwenden Sie den Passphrase-Modus für Konten, die Sie manuell eingeben müssen; sie sind leichter zu merken, aber trotzdem sicher.</li><li>Generieren Sie für maximale Sicherheit das längste vom Dienst erlaubte Passwort (oft 64 oder 128 Zeichen).</li><li>Überprüfen Sie regelmäßig Ihre gespeicherten Passwörter mit der integrierten Sicherheitsprüffunktion Ihres Passwortmanagers.</li><li>Erwägen Sie die Verwendung von Plus-Aliasen (z.B. benutzer+dienst@gmail.com), um zu verfolgen, welche Dienste Ihre Daten verkaufen.</li></ul>",
      },
    },
    "hash-calculator": {
      name: "Hash-Rechner",
    ...
    "cidr-calculator": {
      ...
      cheatsheet: {
        ...
        h0: "Häufige Subnetze",
        h1: "Private Bereiche (RFC 1918)",
        c0: '<table> <tr><th>CIDR</th><th data-i18n="tools.cidr-calculator.ui.th18">Subnetzmaske</th><th data-i18n="tools.cidr-calculator.ui.th19">Hosts</th><th data-i18n="tools.cidr-calculator.ui.th20">Anwendungsfall</th></tr> <tr><td><code>/32</code></td><td>255.255.255.255</td><td>1</td><td>Einzelner Host</td></tr> <tr><td><code>/24</code></td><td>255.255.255.0</td><td>254</td><td>Kleines Netzwerk</td></tr> <tr><td><code>/16</code></td><td>255.255.0.0</td><td>65.534</td><td>Mittleres Netzwerk</td></tr> <tr><td><code>/8</code></td><td>255.0.0.0</td><td>16M+</td><td>Großes Netzwerk</td></tr> </table>',
        c1: '<table> <tr><th data-i18n="tools.cidr-calculator.ui.th13">Bereich</th><th>CIDR</th><th data-i18n="tools.cidr-calculator.ui.th21">Klasse</th></tr> <tr><td>10.0.0.0 – 10.255.255.255</td><td><code>10.0.0.0/8</code></td><td>A</td></tr> <tr><td>172.16.0.0 – 172.31.255.255</td><td><code>172.16.0.0/12</code></td><td>B</td></tr> <tr><td>192.168.0.0 – 192.168.255.255</td><td><code>192.168.0.0/16</code></td><td>C</td></tr> </table>',
      },
    },
    "dns-reference": {
    ...
    "cron-builder": {
      ...
      cheatsheet: {
        title: "Cron-Syntax-Referenz",
        h0: "Feldreihenfolge",
        h1: "Sonderzeichen",
        h2: "Häufige Beispiele",
        c0: '<table> <tr><th data-i18n="tools.cron-builder.ui.th0">Position</th><th data-i18n="tools.cron-builder.ui.th1">Feld</th><th data-i18n="tools.cron-builder.ui.th2">Bereich</th></tr> <tr><td>1</td><td>Minute</td><td>0–59</td></tr> <tr><td>2</td><td>Stunde</td><td>0–23</td></tr> <tr><td>3</td><td>Tag des Monats</td><td>1–31</td></tr> <tr><td>4</td><td>Monat</td><td>1–12</td></tr> <tr><td>5</td><td>Wochentag</td><td>0–7 (0,7 = So)</td></tr> </table>',
        c1: '<table> <tr><th data-i18n="tools.cron-builder.ui.th3">Zeichen</th><th data-i18n="tools.cron-builder.ui.th4">Bedeutung</th><th data-i18n="tools.cron-builder.ui.th5">Beispiel</th></tr> <tr><td><code>*</code></td><td>Beliebiger Wert</td><td>Jede Minute</td></tr> <tr><td><code>,</code></td><td>Liste</td><td><code>1,15</code> (1. und 15.)</td></tr> <tr><td><code>-</code></td><td>Bereich</td><td><code>1-5</code> (Mo–Fr)</td></tr> <tr><td><code>/</code></td><td>Schritt</td><td><code>*/5</code> (alle 5 Min.)</td></tr> </table>',
        c2: '<table> <tr><th data-i18n="tools.cron-builder.ui.th6">Ausdruck</th><th data-i18n="tools.cron-builder.ui.th7">Beschreibung</th></tr> <tr><td><code>0 * * * *</code></td><td>Jede Stunde</td></tr> <tr><td><code>0 0 * * *</code></td><td>Täglich um Mitternacht</td></tr> <tr><td><code>0 0 * * 1</code></td><td>Jeden Montag</td></tr> <tr><td><code>*/5 * * * *</code></td><td>Alle 5 Minuten</td></tr> <tr><td><code>0 9-17 * * 1-5</code></td><td>Stündlich 9–17 Uhr werktags</td></tr> </table>',
      },
    },
    "ssh-key-generator": {
    ...
    "color-converter": {
      ...
      edu: {
        ...
        heading3: "Häufige Anwendungsfälle",
        heading4: "Profi-Tipps",
        p1: "<p>Farbmodelle sind mathematische Systeme zur Darstellung von Farben. <strong>HEX</strong> (Hexadezimal) ist ein 6-stelliger Code, der in HTML und CSS verwendet wird und Rot-, Grün- und Blaukomponenten darstellt. <strong>RGB</strong> (Rot, Grün, Blau) verwendet Dezimalwerte von 0 bis 255 für jeden Kanal, häufig in der digitalen Bildverarbeitung eingesetzt.</p><p><strong>HSL</strong> (Farbton, Sättigung, Helligkeit) ist für Menschen intuitiver, da es Farbe in Bezug auf ihren Grundfarbton (Hue), Intensität (Saturation) und Helligkeit (Lightness) beschreibt. Das Verständnis dieser Modelle hilft bei der Auswahl des richtigen Formats für Design- und Entwicklungsanforderungen, um Konsistenz über verschiedene Plattformen und Geräte hinweg zu gewährleisten.</p>",
        p2: "<ol><li>Verwenden Sie den visuellen Farbwähler, um eine Farbe durch Ziehen des Cursors im Sättigungs-/Helligkeitsquadrat und dem Farbtonregler auszuwählen.</li><li>Alternativ geben Sie einen bestimmten Wert in das Feld &laquo;Manuelle Eingabe&raquo; ein (unterstützt #hex, rgb oder hsl-Formate).</li><li>Beobachten Sie das Vorschaufeld, um die ausgewählte Farbe in Echtzeit zu sehen.</li><li>Zeigen Sie die konvertierten Werte in den HEX-, RGB-, HSL- und HSV-Karten unten an.</li><li>Klicken Sie auf das &laquo;Kopieren&raquo;-Symbol auf einer Karte, um dieses spezifische Format in die Zwischenablage zu kopieren.</li></ol>",
        p3: "<ul><li><strong>Webdesign:</strong> Farben aus Design-Tools (oft RGB/HSL) in HEX-Codes für die Verwendung in CSS-Stylesheets konvertieren.</li><li><strong>Markenkonsistenz:</strong> Sicherstellen, dass Ihre Markenfarben über verschiedene digitale Formate und Medien hinweg korrekt dargestellt werden.</li><li><strong>UI-Entwicklung:</strong> Schnell hellere oder dunklere Variationen einer Grundfarbe generieren, indem der Helligkeitswert in HSL angepasst wird.</li><li><strong>Barrierefreiheitstests:</strong> Die Vorschau nutzen, um zu prüfen, ob die gewählten Farben ausreichend Kontrast für lesbaren Text und UI-Elemente bieten.</li></ul>",
        p4: "<ul><li>Verwenden Sie HSL beim Entwerfen von UI-Komponenten wie Schaltflächen, da es einfach macht, Hover-Zustände durch Anpassen des Helligkeitswerts zu erstellen.</li><li>Bevorzugen Sie bei der Arbeit mit Transparenz in CSS <code>rgba()</code> oder <code>hsla()</code> für bessere Lesbarkeit und Kontrolle über den Alpha-Kanal.</li><li>Überprüfen Sie immer Farbkontrastverhältnisse, um sicherzustellen, dass Ihre Designs für Benutzer mit Sehbeeinträchtigungen zugänglich sind.</li></ul>",
      },
    },
    "unit-converter": {
    ...
    "mock-data-generator": {
      ...
      edu: {
        heading1: "Was sind Mock-Daten?",
        p1: "<p>Mock-Daten sind synthetische Informationen, die reale Daten imitieren, ohne sensible oder personenbezogene Daten (PII) zu enthalten. Sie sind für Entwickler und Tester unverzichtbar, die realistische Datensätze benötigen, um Anwendungen zu erstellen und zu validieren, ohne das Risiko von Datenlecks oder die Verletzung von Datenschutzvorschriften wie DSGVO oder CCPA einzugehen. Durch die Verwendung von Mock-Daten können Sie verschiedene Szenarien simulieren und sicherstellen, dass Ihre Software alle Arten von Eingaben ordnungsgemäß verarbeitet.</p>",
        heading2: "Teststrategien",
        p2: "<p>Effektives Testen erfordert vielfältige Datensätze. Verwenden Sie Mock-Daten, um Ihre Entwicklungsdatenbanken zu befüllen, Lasttests mit Tausenden von Datensätzen durchzuführen oder UI-Layouts mit variierenden Zeichenkettenlängen zu überprüfen. Es ist besonders nützlich für Integrationstests, bei denen Sie vorhersehbare Antworten von externen APIs benötigen. Durch die lokale Generierung von Daten können Sie konsistente Testumgebungen erstellen, die leicht zurückgesetzt und reproduziert werden können.</p>",
        heading3: "Datenschutz bei Mock-Daten",
        p3: "<p>Datenschutz hat in der modernen Softwareentwicklung höchste Priorität. Die Verwendung echter Produktionsdaten in Entwicklungs- oder Staging-Umgebungen ist ein erhebliches Sicherheitsrisiko. Mock-Datengeneratoren lösen dieses Problem, indem sie gefälschte, aber strukturell korrekte Daten erzeugen. Unser Tool läuft vollständig in Ihrem Browser, was bedeutet, dass Ihre Konfiguration und die generierten Daten Ihr Gerät nie verlassen.</p>",
        heading4: "Profi-Tipps",
        p4: "<ul><li><strong>Konsistenz:</strong> Verwenden Sie feste Seeds oder Muster, um beim Generieren mehrerer verwandter Datensätze referenzielle Integrität zwischen Tabellen zu gewährleisten.</li><li><strong>Randfälle:</strong> Fügen Sie leere Zeichenketten, sehr lange Namen und Sonderzeichen hinzu, um die Robustheit Ihrer Anwendung zu testen.</li><li><strong>Format-Wechsel:</strong> Verwenden Sie den SQL-Export für schnelles Datenbankseeding und CSV für Tabellenanalyse oder Massenimporte.</li><li><strong>Automatisierung:</strong> Die Muster dieses Tools können in Ihre automatisierten CI/CD-Pipelines für kontinuierliches Testen integriert werden.</li></ul>",
      },
      cheatsheet: {
        title: "Mock-Daten-Feldtypen",
        h0: "Verfügbare Typen",
        c0: "<table><tr><th>Typ</th><th>Beispielausgabe</th></tr><tr><td><code>name</code></td><td>John Smith</td></tr><tr><td><code>email</code></td><td>john@example.com</td></tr><tr><td><code>phone</code></td><td>+1-555-0123</td></tr><tr><td><code>address</code></td><td>123 Main St</td></tr><tr><td><code>date</code></td><td>2024-03-15</td></tr><tr><td><code>uuid</code></td><td>550e8400-e29b...</td></tr><tr><td><code>number</code></td><td>42</td></tr><tr><td><code>boolean</code></td><td>true / false</td></tr><tr><td><code>url</code></td><td>https://example.com</td></tr><tr><td><code>ip</code></td><td>192.168.1.1</td></tr><tr><td><code>color</code></td><td>#ff6b35</td></tr><tr><td><code>company</code></td><td>Acme Corp</td></tr></table>",
      },
    },
    "markdown-editor": {
