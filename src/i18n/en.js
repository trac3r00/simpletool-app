  ...
  tools: {
    ...
    "password-generator": {
      ...
      edu: {
        ...
        p1: "<p>A secure password is your first line of defense against unauthorized access. In the modern era of high-speed computing, secure is defined by <strong>entropy</strong> — the measure of randomness and unpredictability in a string. A strong password should be long (at least 16 characters), unique to every account, and composed of a diverse set of character types including uppercase, lowercase, numbers, and symbols.</p><p>Avoid using personal information like birthdays, pet names, or common dictionary words. Even complex-looking substitutions like P@ssw0rd123 are easily cracked by modern brute-force tools that use massive dictionaries of common patterns.</p>",
        heading2: "How to Use This Tool",
        p2: "<ol><li><strong>Select your mode:</strong> Choose between Password, Username, Passphrase, or Email Alias depending on your needs.</li><li><strong>Adjust length:</strong> Use the slider to set the desired length. For passwords, 16+ characters is recommended for high security.</li><li><strong>Configure options:</strong> Toggle character sets (symbols, numbers, etc.) or styles (readable vs. secure).</li><li><strong>Generate:</strong> Click the Generate button to create your unique credential.</li><li><strong>Copy:</strong> Use the copy icon to safely move the result to your clipboard or password manager.</li></ol>",
        heading3: "Common Use Cases",
        p3: "<ul><li><strong>Account Security:</strong> Generating unique, high-entropy passwords for every online service you use.</li><li><strong>System Administration:</strong> Creating secure temporary passwords for new users or service accounts.</li><li><strong>Privacy Protection:</strong> Using Plus Aliases (e.g., user+service@domain.com) to track which services sell your data or to filter spam.</li><li><strong>Memorable Security:</strong> Using the Passphrase generator for master passwords that need to be typed manually but remain resistant to cracking.</li></ul>",
        heading4: "Pro Tips",
        p4: "<ul><li><strong>Use a Password Manager:</strong> Never try to memorize complex passwords. Use this tool to generate them, and store them in a reputable password manager like Bitwarden, 1Password, or KeePassXC.</li><li><strong>Entropy over Complexity:</strong> Length is often more important than character variety. A 20-character lowercase password is often harder to crack than an 8-character complex one.</li><li><strong>Rotate on Breach:</strong> If a service you use is compromised, use this generator to create a completely new, unrelated password immediately.</li></ul>",
        heading5: "What Makes a Password Secure?",
        p5: "<p>A secure password is your first line of defense against unauthorized access. In the modern era of high-speed computing, secure is defined by <strong>entropy</strong> — the measure of randomness and unpredictability in a string. A strong password should be long (at least 16 characters), unique to every account, and composed of a diverse set of character types including uppercase, lowercase, numbers, and symbols.</p><p>Avoid using personal information like birthdays, pet names, or common dictionary words. Even complex-looking substitutions like P@ssw0rd123 are easily cracked by modern brute-force tools that use massive dictionaries of common patterns.</p>",
        heading6: "Entropy Explained",
        p6: "<p>Entropy is a measure of the randomness and unpredictability of a password, typically expressed in bits. The higher the entropy, the stronger the password. For example, a 10-character password using only lowercase letters has much lower entropy than a 10-character password using a full set of alphanumeric and special characters.</p><p>Our generator calculates entropy in real-time to give you an objective measure of your password strength. A password with over 100 bits of entropy is considered exceptionally strong and resistant to modern cracking techniques.</p>",
        heading7: "Best Practices",
        p7: "<ul><li><strong>Never Reuse Passwords:</strong> Use a unique password for every single account. If one service is breached, your other accounts remain safe.</li><li><strong>Use a Password Manager:</strong> Since humans cannot remember dozens of complex, unique passwords, use a reputable password manager to store them securely.</li><li><strong>Enable MFA:</strong> Multi-Factor Authentication adds a critical second layer of security even if your password is compromised.</li><li><strong>Avoid Personal Info:</strong> Never include names, birthdays, or common words that can be found in a dictionary.</li></ul>",
        heading8: "Pro Tips",
        p8: "<ul><li>Use the Passphrase mode for accounts you need to type manually; they are easier to remember but still highly secure.</li><li>For maximum security, generate the longest password allowed by the service (often 64 or 128 characters).</li><li>Regularly audit your saved passwords using your password manager built-in security check features.</li><li>Consider using Plus Aliases (e.g., user+service@gmail.com) to track which services sell your data or send spam.</li></ul>",
      },
    },
    "hash-calculator": {
      name: "Hash Calculator",
      desc: "Compute SHA256, MD5, and other hashes.",
      ui: {
        button0: "📝 Text",
        button1: "📁 File",
        button2: "✓ Verify",
    ...
    "cidr-calculator": {
      ...
      desc: "Calculate IPv4/IPv6 subnets and ranges.",
      ui: {
        button0: "2001:db8::/32",
    ...
    "dns-reference": {
      ...
      desc: "Interactive reference for DNS record types with syntax, examples, and command builders.",
      ui: {
        button0: "Copy",
        label1: "Record Type",
        label2: "Domain",
    ...
    "port-reference": {
      name: "Port Reference",
      desc: "Searchable IANA port database with security risk levels and protocol filters.",
      ui: {
        button0: "All",
    ...
    "bandwidth-calculator": {
      ...
      desc: "Calculate transfer times, bandwidth needs, and TCP overhead.",
      ui: {
        button0: "1 GB",
        button1: "DVD (4.7GB)",
    ...
    "wireguard-config": {
      ...
      desc: "Generate WireGuard configurations with local key generation and QR export.",
      ui: {
        button0: "Show",
        button1: "Copy",
    ...
    "wireshark-filter": {
      ...
      desc: "Build Wireshark display filters and BPF capture expressions visually.",
      ui: {
    ...
    "protocol-headers": {
      ...
      desc: "Interactive bit-level diagrams for Ethernet, IPv4, IPv6, TCP, UDP, ICMP, and ARP.",
      ui: {
        button0: "Ethernet II",
        button1: "IPv4",
        button2: "IPv6",
    ...
    "jwk-jwks-studio": {
      ...
      desc: "Convert PEM/JWK/JWKS, compute RFC7638 thumbprints, and verify JWT signatures offline.",
      ui: {
    ...
    "text-diff": {
      name: "Text Diff",
      desc: "Compare two text files for differences.",
      ui: {
    ...
    "regex-visualizer": {
      name: "Regex Studio",
      desc: "Visualize, explain, and test regular expressions with real-time diagrams.",
      ui: {
        button0: "JavaScript",
        button1: "Python",
        button2: "Java",
    ...
    "universal-decoder": {
      ...
      desc: "Auto-detect and unwrap layered encodings (Base64, URL, Hex, and more).",
      ui: {
        button0: "Analyze",
        button1: "Double URL",
        button2: "UTF-16",
    ...
    "cron-builder": {
      name: "Cron Builder",
      desc: "Visual cron editor with human-readable descriptions and next-run preview.",
      ui: {
        button0: "Minute",
        button1: "Hour",
        button2: "Day",
    ...
    "certificate-decoder": {
      ...
      desc: "Parse X.509 certificates and CSRs.",
      ui: {
    ...
    "saml-decoder": {
      name: "SAML Inspector",
      desc: "Decode SAML requests and responses.",
      ui: {
        button0: "Clear",
        button1: "Load sample",
        button2: "Copy JSON",
    ...
    "qr-code": {
      name: "QR Code Studio",
      desc: "Generate QR codes for URLs and text.",
      ui: {
    ...
    "timestamp-converter": {
      ...
      desc: "Convert Unix timestamps to human dates.",
      ui: {
        button0: "Now",
    ...
    "yaml-toml-converter": {
      ...
      desc: "Convert between YAML, TOML, and JSON.",
      ui: {
        button0: "Load sample",
    ...
    "htpasswd-generator": {
      ...
      desc: "Generate apache htpasswd entries.",
      ui: {
        button0: "Show",
    ...
    "mock-data-generator": {
      ...
      desc: "Generate random JSON/CSV data.",
      ui: {
        button0: "Copy",
        button1: "Download",
        label2: "Rows",
    ...
    "log-viewer": {
      name: "Log Viewer",
      desc: "Analyze large log files locally with filtering and visualization.",
      ui: {
        label0: "Log File",
        label1: "Filter",
    ...
    "case-converter": {
      ...
      desc: "Convert text case (camel, snake, etc).",
      ui: {
        label0: "Input Text",
    ...
    "code-minifier": {
      name: "Code Minifier",
      desc: "Minify JS, CSS, and HTML code.",
      ui: {
        button0: "JavaScript",
    ...
    "image-converter": {
      ...
      desc: "Convert and resize images locally.",
      ui: {
    ...
    "curl-studio": {
      name: "Curl Studio",
      desc: "Parse and generate curl commands.",
      ui: {
    ...
    "log-masker": {
      name: "Log Masker",
      desc: "Redact PII from logs locally.",
      ui: {
        button0: "Mask Logs",
        button1: "Copy Result",
        label2: "Raw Logs",
    ...
    "mermaid-studio": {
      name: "Mermaid Studio",
      desc: "Live Mermaid.js diagram editor.",
      ui: {
        button0: "Load Sample",
    ...
    "json-schema-studio": {
      ...
      desc: "Generate JSON Schema from JSON.",
      ui: {
        button0: "Beautify",
        button1: "Sample",
    ...
    caffeinate: {
      name: "Caffeinate",
      desc: "Keep your device screen awake using the Wake Lock API. No downloads, fully client-side.",
      ui: {
    ...
    "email-analyzer": {
      ...
      desc: "Understand SPF, DKIM, DMARC, routing hops, and embedded URLs from a raw email — all locally.",
      ui: {
        badge0: "Client-Side Only",
        badge1: "SOC-Friendly",
        button0: "Analyze",
    ...
    "prompt-template-builder": {
      ...
      desc: "Generate a clean, reusable prompt template optimized for GPT, Claude, and other chat models.",
      ui: {
        badge0: "Reusable",
    ...
    "sql-formatter": {
      ...
      desc: "Format SQL and catch common syntax issues. Supports Postgres/MySQL-friendly formatting (offline).",
      ui: {
        badge0: "Formatter",
        badge1: "Validator",
        button0: "Format",
    ...
    "env-var-manager": {
      ...
      desc: "Compare .env files across environments and generate a share-safe (masked) diff.",
      ui: {
        badge0: "Diff",
        badge1: "Mask Secrets",
        button0: "Compare",
    ...
    "svg-optimizer": {
      ...
      desc: "Clean up and preview SVGs, then quickly adjust fill/stroke colors — all locally.",
      ui: {
        badge0: "Sanitized",
    ...
    "csp-builder": {
      ...
      desc: "Build a Content-Security-Policy header with clear explanations and safety checks.",
      ui: {
        badge0: "Interactive",
    ...
    "secret-scanner": {
      name: "Secret Scanner",
      desc: "Scan pasted code/config for leaked API keys, tokens, and passwords — then generate a share-safe redaction.",
      ui: {
        badge0: "Local Only",
        badge1: "Actionable",
        button0: "Scan",
    ...
    "token-studio": {
      ...
      desc: "Inspect, generate, and manage JWT tokens and cryptographic keys.",
      ui: {
    ...
    "encoding-workbench": {
      ...
      desc: "Encode, decode, hash, and identify data transformations.",
      ui: {
    ...
    "ladder-game": {
      name: "Ladder Game",
      desc: "Classic ghost leg ladder game for random matching and decision making.",
      ui: {
        badge0: "Client-Side Only",
    ...
    "roulette-wheel": {
      name: "Roulette Wheel",
      desc: "Spin the wheel for fair random picks with real-time statistics.",
      ui: {
    ...
    "marble-roulette": {
      ...
      desc: "Drop marbles through pegs for a physics-based lucky draw.",
      ui: {
        badge0: "Client-Side Only",
