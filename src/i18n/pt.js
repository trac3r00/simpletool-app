...
export default {
  ...
  footer: {
    ...
    github: "GitHub",
    tagline: "Ferramentas web focadas em privacidade para desenvolvedores.",
    ...
    privacyNote:
      "Desenvolvido com foco em privacidade. Todas as ferramentas rodam no cliente.",
  },
  common: {
    copy: "Copiar",
    copied: "Copiado",
  ...
  home: {
    heroTitle: "Ferramentas online gratuitas para devs",
    heroLine1:
    ...
    cat: {
      ...
      security: "🛡️ Segurança e Criptografia",
      network: "🌐 Rede e Web",
      generators: "⚡ Geradores",
      game: "🎮 Jogos e Diversão",
      utils: "🛠️ Utilitários",
    },
  },
  tools: {
    "json-formatter": {
      ...
      edu: {
        heading1: "O que é JSON?",
        p1: "<p>JSON (JavaScript Object Notation) é um formato leve de troca de dados, fácil de ler e escrever para humanos e fácil de analisar e gerar para máquinas. É baseado em um subconjunto do padrão JavaScript. O JSON é um formato de texto completamente independente de linguagem, mas usa convenções familiares aos programadores das linguagens da família C.</p><p>Essas propriedades tornam o JSON ideal para troca de dados em aplicações web, APIs e arquivos de configuração. Ele se tornou o padrão de fato para troca de dados na web, substituindo amplamente o XML por seu menor tamanho e melhor desempenho.</p>",
        heading2: "Como usar esta ferramenta",
        p2: "<ol><li>Cole seus dados JSON brutos ou desorganizados no editor à esquerda.</li><li>Clique em Format para embelezar o código com indentação adequada e destaque de sintaxe.</li><li>Alternativamente, use Minify para remover todos os espaços em branco para uso em produção.</li><li>Verifique o indicador de Status para garantir que seu JSON é válido; se houver um erro, a ferramenta destacará a linha exata.</li><li>Clique em Copy para salvar o resultado formatado na área de transferência ou Clear para recomeçar.</li></ol>",
        heading3: "Casos de uso comuns",
        p3: "<ul><li><strong>Depuração de API:</strong> Formatar rapidamente respostas JSON ilegíveis de APIs REST para inspecionar estruturas de dados.</li><li><strong>Validação de configuração:</strong> Garantir que seus arquivos <code>package.json</code>, <code>tsconfig.json</code> ou outros arquivos de configuração estejam sintaticamente corretos.</li><li><strong>Preparação de dados:</strong> Minificar dados JSON antes de incorporá-los em código ou enviá-los pela rede para economizar largura de banda.</li><li><strong>Aprendizado &amp; Documentação:</strong> Usar a saída formatada para criar exemplos claros para documentação técnica ou tutoriais.</li></ul>",
        heading4: "Dicas avançadas",
        p4: "<ul><li>Use o botão Validate se quiser apenas verificar erros de sintaxe sem alterar a formatação da sua entrada.</li><li>Preste atenção à estatística de Profundidade Máxima para identificar estruturas excessivamente complexas ou profundamente aninhadas que podem causar problemas de desempenho.</li><li>Sempre use aspas duplas para chaves e valores de string, pois aspas simples são inválidas no JSON padrão.</li></ul>",
      },
    },
    "jwt-decoder": {
      name: "Inspetor JWT",
    ...
    "password-generator": {
      ...
      edu: {
        ...
        p1: "<p>Uma senha segura é sua primeira linha de defesa contra acesso não autorizado. Na era moderna da computação de alta velocidade, segurança é definida pela <strong>entropia</strong> — a medida de aleatoriedade e imprevisibilidade de uma string. Uma senha forte deve ser longa (pelo menos 16 caracteres), única para cada conta e composta por uma combinação diversa de tipos de caracteres, incluindo maiúsculas, minúsculas, números e símbolos.</p><p>Evite usar informações pessoais como datas de aniversário, nomes de animais de estimação ou palavras comuns do dicionário. Até substituições que parecem complexas, como P@ssw0rd123, são facilmente quebradas por ferramentas modernas de força bruta que usam enormes dicionários de padrões comuns.</p>",
        heading2: "Como usar esta ferramenta",
        p2: "<ol><li><strong>Selecione o modo:</strong> Escolha entre Senha, Nome de usuário, Frase-senha ou Alias de e-mail conforme sua necessidade.</li><li><strong>Ajuste o comprimento:</strong> Use o controle deslizante para definir o comprimento desejado. Para senhas, 16+ caracteres é recomendado para alta segurança.</li><li><strong>Configure as opções:</strong> Ative ou desative conjuntos de caracteres (símbolos, números, etc.) ou estilos (legível vs. seguro).</li><li><strong>Gerar:</strong> Clique no botão Gerar para criar sua credencial única.</li><li><strong>Copiar:</strong> Use o ícone de cópia para mover o resultado com segurança para sua área de transferência ou gerenciador de senhas.</li></ol>",
        heading3: "Casos de uso comuns",
        p3: "<ul><li><strong>Segurança de conta:</strong> Gerar senhas únicas e de alta entropia para cada serviço online que você usa.</li><li><strong>Administração de sistemas:</strong> Criar senhas temporárias seguras para novos usuários ou contas de serviço.</li><li><strong>Proteção de privacidade:</strong> Usar aliases Plus (ex.: usuario+servico@domain.com) para rastrear quais serviços vendem seus dados ou filtrar spam.</li><li><strong>Segurança memorável:</strong> Usar o gerador de frase-senha para senhas mestras que precisam ser digitadas manualmente, mas ainda resistem a ataques.</li></ul>",
        heading4: "Dicas avançadas",
        p4: "<ul><li><strong>Use um gerenciador de senhas:</strong> Nunca tente memorizar senhas complexas. Use esta ferramenta para gerá-las e armazene-as em um gerenciador confiável como Bitwarden, 1Password ou KeePassXC.</li><li><strong>Entropia antes de complexidade:</strong> O comprimento frequentemente é mais importante que a variedade de caracteres. Uma senha de 20 caracteres em minúsculas é muitas vezes mais difícil de quebrar do que uma de 8 caracteres complexos.</li><li><strong>Troque após vazamentos:</strong> Se um serviço que você usa for comprometido, use este gerador para criar uma senha completamente nova e sem relação imediatamente.</li></ul>",
        heading5: "O que torna uma senha segura?",
        p5: "<p>Uma senha segura é sua primeira linha de defesa contra acesso não autorizado. Na era moderna da computação de alta velocidade, segurança é definida pela <strong>entropia</strong>. Uma senha forte deve ser longa, única e diversificada.</p>",
        heading6: "Entropie explicada",
        p6: "<p>Entropia é uma medida da aleatoriedade e imprevisibilidade de uma senha, geralmente expressa em bits. Quanto maior a entropia, mais forte a senha. Nosso gerador calcula a entropia em tempo real para oferecer uma medida objetiva da força da sua senha.</p>",
        heading7: "Boas práticas",
        p7: "<ul><li><strong>Nunca reutilize senhas:</strong> Use uma senha única para cada conta.</li><li><strong>Use um gerenciador de senhas:</strong> Como humanos não conseguem lembrar dezenas de senhas complexas, use um gerenciador confiável.</li><li><strong>Ative a MFA:</strong> A Autenticação Multifator adiciona uma segunda camada crítica de segurança.</li><li><strong>Evite informações pessoais:</strong> Nunca inclua nomes, datas de aniversário ou palavras comuns.</li></ul>",
        heading8: "Dicas avançadas",
        p8: "<ul><li>Use o modo Frase-senha para contas que você precisa digitar manualmente; são mais fáceis de lembrar mas ainda muito seguras.</li><li>Para segurança máxima, gere a senha mais longa permitida pelo serviço (frequentemente 64 ou 128 caracteres).</li><li>Audite regularmente suas senhas salvas usando os recursos de verificação de segurança integrados do seu gerenciador.</li><li>Considere usar aliases Plus (ex.: usuario+servico@gmail.com) para rastrear quais serviços vendem seus dados.</li></ul>",
      },
    },
    "hash-calculator": {
    ...
    "cidr-calculator": {
      ...
      cheatsheet: {
        ...
        h0: "Sub-redes comuns",
        h1: "Intervalos privados (RFC 1918)",
        c0: '<table> <tr><th>CIDR</th><th data-i18n="tools.cidr-calculator.ui.th18">Máscara de sub-rede</th><th data-i18n="tools.cidr-calculator.ui.th19">Hosts</th><th data-i18n="tools.cidr-calculator.ui.th20">Caso de uso</th></tr> <tr><td><code>/32</code></td><td>255.255.255.255</td><td>1</td><td>Host único</td></tr> <tr><td><code>/24</code></td><td>255.255.255.0</td><td>254</td><td>Rede pequena</td></tr> <tr><td><code>/16</code></td><td>255.255.0.0</td><td>65.534</td><td>Rede média</td></tr> <tr><td><code>/8</code></td><td>255.0.0.0</td><td>16M+</td><td>Rede grande</td></tr> </table>',
        c1: '<table> <tr><th data-i18n="tools.cidr-calculator.ui.th13">Intervalo</th><th>CIDR</th><th data-i18n="tools.cidr-calculator.ui.th21">Classe</th></tr> <tr><td>10.0.0.0 – 10.255.255.255</td><td><code>10.0.0.0/8</code></td><td>A</td></tr> <tr><td>172.16.0.0 – 172.31.255.255</td><td><code>172.16.0.0/12</code></td><td>B</td></tr> <tr><td>192.168.0.0 – 192.168.255.255</td><td><code>192.168.0.0/16</code></td><td>C</td></tr> </table>',
      },
    },
    "dns-reference": {
    ...
    "cron-builder": {
      ...
      cheatsheet: {
        title: "Referência de sintaxe Cron",
        h0: "Ordem dos campos",
        h1: "Caracteres especiais",
        h2: "Exemplos comuns",
        c0: '<table> <tr><th data-i18n="tools.cron-builder.ui.th0">Posição</th><th data-i18n="tools.cron-builder.ui.th1">Campo</th><th data-i18n="tools.cron-builder.ui.th2">Intervalo</th></tr> <tr><td>1</td><td>Minuto</td><td>0–59</td></tr> <tr><td>2</td><td>Hora</td><td>0–23</td></tr> <tr><td>3</td><td>Dia do mês</td><td>1–31</td></tr> <tr><td>4</td><td>Mês</td><td>1–12</td></tr> <tr><td>5</td><td>Dia da semana</td><td>0–7 (0,7 = Dom)</td></tr> </table>',
        c1: '<table> <tr><th data-i18n="tools.cron-builder.ui.th3">Caractere</th><th data-i18n="tools.cron-builder.ui.th4">Significado</th><th data-i18n="tools.cron-builder.ui.th5">Exemplo</th></tr> <tr><td><code>*</code></td><td>Qualquer valor</td><td>Todo minuto</td></tr> <tr><td><code>,</code></td><td>Lista</td><td><code>1,15</code> (1º e 15º)</td></tr> <tr><td><code>-</code></td><td>Intervalo</td><td><code>1-5</code> (Seg–Sex)</td></tr> <tr><td><code>/</code></td><td>Passo</td><td><code>*/5</code> (a cada 5 min)</td></tr> </table>',
        c2: '<table> <tr><th data-i18n="tools.cron-builder.ui.th6">Expressão</th><th data-i18n="tools.cron-builder.ui.th7">Descrição</th></tr> <tr><td><code>0 * * * *</code></td><td>A cada hora</td></tr> <tr><td><code>0 0 * * *</code></td><td>Diariamente à meia-noite</td></tr> <tr><td><code>0 0 * * 1</code></td><td>Toda segunda-feira</td></tr> <tr><td><code>*/5 * * * *</code></td><td>A cada 5 minutos</td></tr> <tr><td><code>0 9-17 * * 1-5</code></td><td>De hora em hora das 9h às 17h nos dias úteis</td></tr> </table>',
      },
    },
    "ssh-key-generator": {
    ...
    "color-converter": {
      ...
      edu: {
        ...
        heading3: "Casos de uso comuns",
        heading4: "Dicas avançadas",
        p1: "<p>Modelos de cor são sistemas matemáticos para representar cores. <strong>HEX</strong> (Hexadecimal) é um código de 6 dígitos usado em HTML e CSS, representando componentes Vermelho, Verde e Azul. <strong>RGB</strong> (Vermelho, Verde, Azul) usa valores decimais de 0 a 255 para cada canal, frequentemente usado em imagens digitais.</p><p><strong>HSL</strong> (Matiz, Saturação, Luminosidade) é mais intuitivo para humanos, pois descreve a cor em termos de seu pigmento base (Matiz), intensidade (Saturação) e brilho (Luminosidade). Entender esses modelos ajuda a escolher o formato certo para suas necessidades de design e desenvolvimento, garantindo consistência em diferentes plataformas e dispositivos.</p>",
        p2: "<ol><li>Use o seletor visual de cores para selecionar uma cor arrastando o cursor no quadrado de saturação/brilho e no controle deslizante de matiz.</li><li>Como alternativa, insira um valor específico no campo &laquo;Entrada Manual&raquo; (suporta formatos #hex, rgb ou hsl).</li><li>Observe a caixa de &laquo;Visualização&raquo; para ver a cor selecionada em tempo real.</li><li>Veja os valores convertidos nos cartões HEX, RGB, HSL e HSV abaixo.</li><li>Clique no ícone &laquo;Copiar&raquo; em qualquer cartão para salvar esse formato específico na área de transferência.</li></ol>",
        p3: "<ul><li><strong>Web Design:</strong> Converter cores de ferramentas de design (frequentemente RGB/HSL) para códigos HEX para uso em folhas de estilo CSS.</li><li><strong>Consistência de marca:</strong> Garantir que suas cores de marca sejam representadas com precisão em diferentes formatos digitais e mídias.</li><li><strong>Desenvolvimento de UI:</strong> Gerar rapidamente variações mais claras ou escuras de uma cor base ajustando o valor de Luminosidade no HSL.</li><li><strong>Teste de acessibilidade:</strong> Usar a visualização para verificar se suas cores fornecem contraste suficiente para texto legível e elementos de UI.</li></ul>",
        p4: "<ul><li>Use HSL ao projetar componentes de UI como botões, pois facilita a criação de estados de hover simplesmente ajustando o valor de luminosidade.</li><li>Ao trabalhar com transparência em CSS, prefira <code>rgba()</code> ou <code>hsla()</code> para melhor legibilidade e controle sobre o canal alfa.</li><li>Sempre verifique as proporções de contraste de cores para garantir que seus designs sejam acessíveis a usuários com deficiências visuais.</li></ul>",
      },
    },
    "unit-converter": {
    ...
    "mock-data-generator": {
      ...
      edu: {
        ...
        p1: "<p>Dados mock são informações sintéticas que imitam dados reais sem conter informações sensíveis ou pessoalmente identificáveis (PII). São essenciais para desenvolvedores e testadores que precisam de conjuntos de dados realistas para construir e validar aplicações sem arriscar violações de dados ou violar regulamentos de privacidade como GDPR ou CCPA. Ao usar dados mock, você pode simular vários cenários, garantindo que seu software trate todos os tipos de entrada adequadamente.</p>",
        heading2: "Estratégias de teste",
        p2: "<p>Testes eficazes requerem conjuntos de dados diversificados. Use dados mock para popular seus bancos de dados de desenvolvimento, realizar testes de carga com milhares de registros ou verificar layouts de UI com comprimentos de string variados. É particularmente útil para testes de integração onde você precisa de respostas previsíveis de APIs externas. Ao gerar dados localmente, você pode criar ambientes de teste consistentes que são fáceis de redefinir e reproduzir.</p>",
        heading3: "Privacidade de dados em mocks",
        p3: "<p>Privacidade é uma prioridade máxima no desenvolvimento de software moderno. Usar dados reais de produção em ambientes de desenvolvimento ou staging é um grande risco de segurança. Geradores de dados mock resolvem isso produzindo dados falsos mas estruturalmente corretos. Nossa ferramenta roda inteiramente no seu navegador, o que significa que sua configuração e os dados gerados nunca saem do seu dispositivo.</p>",
        heading4: "Dicas avançadas",
        p4: "<ul><li><strong>Consistência:</strong> Ao gerar múltiplos conjuntos de dados relacionados, use seeds fixas ou padrões para manter a integridade referencial entre tabelas.</li><li><strong>Casos extremos:</strong> Inclua strings vazias, nomes muito longos e caracteres especiais para testar a robustez da sua aplicação.</li><li><strong>Troca de formato:</strong> Use a exportação SQL para semear bancos de dados rapidamente e CSV para análise em planilhas ou importações em massa.</li><li><strong>Automação:</strong> Os padrões que esta ferramenta usa podem ser integrados em seus pipelines CI/CD automatizados para testes contínuos.</li></ul>",
      },
      cheatsheet: {
        title: "Tipos de campos de dados mock",
        h0: "Tipos disponíveis",
        c0: "<table><tr><th>Tipo</th><th>Exemplo de saída</th></tr><tr><td><code>name</code></td><td>John Smith</td></tr><tr><td><code>email</code></td><td>john@example.com</td></tr><tr><td><code>phone</code></td><td>+1-555-0123</td></tr><tr><td><code>address</code></td><td>123 Main St</td></tr><tr><td><code>date</code></td><td>2024-03-15</td></tr><tr><td><code>uuid</code></td><td>550e8400-e29b...</td></tr><tr><td><code>number</code></td><td>42</td></tr><tr><td><code>boolean</code></td><td>true / false</td></tr><tr><td><code>url</code></td><td>https://example.com</td></tr><tr><td><code>ip</code></td><td>192.168.1.1</td></tr><tr><td><code>color</code></td><td>#ff6b35</td></tr><tr><td><code>company</code></td><td>Acme Corp</td></tr></table>",
      },
    },
    "markdown-editor": {
