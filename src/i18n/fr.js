...
export default {
  ...
  footer: {
    ...
    faq: "FAQ",
    github: "GitHub",
    tagline: "Outils web axés sur la confidentialité pour les développeurs.",
    ...
    privacyNote:
      "Conçu dans le respect de la vie privée. Tous les outils fonctionnent côté client.",
  },
  common: {
    copy: "Copier",
    copied: "Copié",
  ...
  home: {
    heroTitle: "Outils développeur en ligne gratuits",
    heroLine1:
      "Une collection gratuite et respectueuse de la vie privée pour votre quotidien.",
    heroLine2:
      "Des publicités non personnalisées et étiquetées peuvent apparaître. Les outils mot de passe et clés restent sans publicité.",
    favorites: "Favoris",
    ...
    meta: {
      ...
      description:
        "Outils développeur côté client : formateur JSON, inspecteur JWT, testeur regex, cron, générateur de mots de passe, SSH/certs, curl et calculateur CIDR.",
      keywords:
        "outils en ligne, outils développeur, formateur JSON, générateur de mot de passe, calculateur de hachage, générateur UUID, testeur regex, décodeur base64, générateur QR code, outils gratuits, confidentialité",
    },
    cat: {
      formatters: "🔄 Formateurs et Convertisseurs",
      security: "🛡️ Sécurité et Cryptographie",
      network: "🌐 Réseau et Web",
      generators: "⚡ Générateurs",
      game: "🎮 Jeux et Loisirs",
      utils: "🛠️ Utilitaires",
    },
  },
  tools: {
    "json-formatter": {
      ...
      ui: {
        ...
        button4: "📋 Copy",
        label5: "Input JSON",
        label6: "Formatted Output",
        stat7: "Characters",
        stat8: "Lines",
        stat9: "Keys",
        stat10: "Max Depth",
        badge11: "Client-Side Only",
        badge12: "Privacy First",
        desc13: "No output yet",
        desc14: "Paste JSON on the left, then click Format or Minify.",
      },
      js: {
        status0: "Please enter JSON",
        status1: "Formatted successfully",
        status2: "Minified successfully",
        status3: "Valid JSON",
        status4: "Failed to copy",
        text5: "✓ Valid",
        text6: "✗ Invalid",
        text7: "✓ Copied",
        tpl8: "Max Depth",
      ...
      edu: {
        heading1: "Qu'est-ce que JSON ?",
        p1: "<p>JSON (JavaScript Object Notation) est un format d'\u00e9change de donn\u00e9es l\u00e9ger, facile \u00e0 lire et \u00e0 \u00e9crire pour les humains, et facile \u00e0 analyser et g\u00e9n\u00e9rer pour les machines. Il est bas\u00e9 sur un sous-ensemble du standard du langage de programmation JavaScript. JSON est un format texte compl\u00e8tement ind\u00e9pendant du langage, mais utilise des conventions famili\u00e8res aux programmeurs de la famille de langages C.</p><p>Ces propri\u00e9t\u00e9s font de JSON un langage id\u00e9al d'\u00e9change de donn\u00e9es pour les applications web, les API et les fichiers de configuration. Il est devenu le standard de facto pour l'\u00e9change de donn\u00e9es sur le web, rempla\u00e7ant largement XML gr\u00e2ce \u00e0 son empreinte plus petite et ses meilleures performances.</p>",
        heading2: "Comment utiliser cet outil",
        p2: "<ol><li>Collez vos donn\u00e9es JSON brutes ou d\u00e9sordonn\u00e9es dans l'\u00e9diteur JSON d'entr\u00e9e \u00e0 gauche.</li><li>Cliquez sur le bouton Formater pour embellir le code avec une indentation appropri\u00e9e et une coloration syntaxique.</li><li>Alternativement, utilisez le bouton Minifier pour supprimer tous les espaces blancs pour une utilisation en production.</li><li>V\u00e9rifiez l'indicateur de statut pour vous assurer que votre JSON est valide ; s'il y a une erreur, l'outil mettra en \u00e9vidence la ligne exacte.</li><li>Cliquez sur Copier pour sauvegarder le r\u00e9sultat format\u00e9 dans votre presse-papiers ou sur Effacer pour recommencer.</li></ol>",
        heading3: "Cas d'utilisation courants",
        p3: "<ul><li><strong>D\u00e9bogage d'API :</strong> Formater rapidement les r\u00e9ponses JSON illisibles des APIs REST pour inspecter les structures de donn\u00e9es.</li><li><strong>Validation de configuration :</strong> S'assurer que vos fichiers <code>package.json</code>, <code>tsconfig.json</code> ou autres fichiers de configuration sont syntaxiquement corrects.</li><li><strong>Pr\u00e9paration des donn\u00e9es :</strong> Minifier les donn\u00e9es JSON avant de les int\u00e9grer dans le code ou de les envoyer sur un r\u00e9seau pour \u00e9conomiser la bande passante.</li><li><strong>Apprentissage et documentation :</strong> Utiliser la sortie embellie pour cr\u00e9er des exemples clairs pour la documentation technique ou les tutoriels.</li></ul>",
        heading4: "Conseils de pro",
        p4: "<ul><li>Utilisez le bouton Valider si vous souhaitez uniquement v\u00e9rifier les erreurs de syntaxe sans modifier le formatage de votre entr\u00e9e.</li><li>Faites attention \u00e0 la statistique Profondeur maximale pour identifier les structures excessivement complexes ou profond\u00e9ment imbriqu\u00e9es qui pourraient causer des probl\u00e8mes de performance.</li><li>Utilisez toujours des guillemets doubles pour les cl\u00e9s et les valeurs de cha\u00eene, car les guillemets simples sont invalides en JSON standard.</li></ul>",
      },
    },
    "jwt-decoder": {
      name: "Inspecteur JWT",
      ...
      ui: {
        ...
        desc11: "Paste a JWT token above and click Decode.",
        heading0: "Header",
        heading1: "Payload",
        heading2: "Signature",
        th0: "Claim",
    ...
    "uuid-generator": {
      ...
      ui: {
        ...
        heading9: "ℹ️ About UUID Versions",
        desc10: "Cryptographically strong random UUID",
        desc11: "Hyphenated",
        desc12: "Plain (no hyphens)",
        desc13: "Uppercase",
        desc14: "With braces {}",
        desc15: "content_copy",
        badge16: "Bulk Generation",
    ...
    "password-generator": {
      ...
      ui: {
        button0: "Generate Password",
        button1: "Generate Username",
        button2: "Generate Passphrase",
        button3: "Generate Catch-all Email",
        button4: "Generate Plus Alias",
        label5: "Style",
        label6: "Separator",
        label7: "Custom Prefix (optional)",
        label8: "Custom Domain (optional)",
        label9: "Base Email Address",
        label10: "Password Length: 16",
        label11: "Username Length: 12",
        label12: "Word Count: 4",
        label13: "Random Prefix Length: 12",
        label14: "Tag Length: 6",
        placeholder15: "Leave empty for random",
        placeholder16: "user@example.com",
        option17: "Readable (syllable-based)",
        option18: "Secure (random)",
        option19: "Color (hex-based)",
        option20: "Secure random",
        option21: "Pronounceable",
        heading22: "📬 Catch-all Address",
        heading23: "➕ Plus Alias",
        desc24: "Uppercase (A-Z)",
        desc25: "Lowercase (a-z)",
        desc26: "Numbers (0-9)",
        desc27: "Symbols (!@#$)",
        desc28: "Your Password:",
        desc29: "Include numbers",
        desc30: "Your Username:",
        desc31: "Capitalize words",
        desc32: "Your Passphrase:",
        desc33: "Catch-all Email:",
        desc34: "Plus Alias:",
        badge35: "Client-Side Only",
        badge36: "Privacy First",
        tab0: "Password",
        tab1: "Username",
        tab2: "Passphrase",
        tab3: "Email",
      ...
      js: {
        text0: "Strength:",
        alert1: "Please select at least one character type!",
        alert2: "Password length too short for selected options.",
        alert3: "Please enter a valid base email address",
        tpl4: "content_copy",
        status3: "Strong",
        status4: "Good",
        status5: "Fair",
      ...
      edu: {
        ...
        p1: "<p>Un mot de passe s\u00e9curis\u00e9 est votre premi\u00e8re ligne de d\u00e9fense contre les acc\u00e8s non autoris\u00e9s. \u00c0 l'\u00e8re du calcul haute vitesse, la s\u00e9curit\u00e9 est d\u00e9finie par l'<strong>entropie</strong> \u2014 la mesure de l'al\u00e9atoire et de l'impr\u00e9visibilit\u00e9 d'une cha\u00eene. Un mot de passe fort doit \u00eatre long (au moins 16 caract\u00e8res), unique pour chaque compte, et compos\u00e9 d'un ensemble diversifi\u00e9 de types de caract\u00e8res incluant majuscules, minuscules, chiffres et symboles.</p><p>\u00c9vitez d'utiliser des informations personnelles comme les dates de naissance, les noms d'animaux ou les mots courants du dictionnaire. M\u00eame des substitutions d'apparence complexe comme P@ssw0rd123 sont facilement d\u00e9chiffr\u00e9es par des outils modernes de force brute qui utilisent de vastes dictionnaires de motifs courants.</p>",
        heading2: "Comment utiliser cet outil",
        p2: "<ol><li><strong>S\u00e9lectionnez votre mode :</strong> Choisissez entre Mot de passe, Nom d'utilisateur, Phrase de passe ou Alias e-mail selon vos besoins.</li><li><strong>Ajustez la longueur :</strong> Utilisez le curseur pour d\u00e9finir la longueur souhait\u00e9e. Pour les mots de passe, 16+ caract\u00e8res sont recommand\u00e9s pour une haute s\u00e9curit\u00e9.</li><li><strong>Configurez les options :</strong> Activez ou d\u00e9sactivez les jeux de caract\u00e8res (symboles, chiffres, etc.) ou les styles (lisible vs. s\u00e9curis\u00e9).</li><li><strong>G\u00e9n\u00e9rer :</strong> Cliquez sur le bouton G\u00e9n\u00e9rer pour cr\u00e9er vos identifiants uniques.</li><li><strong>Copier :</strong> Utilisez l'ic\u00f4ne de copie pour d\u00e9placer en toute s\u00e9curit\u00e9 le r\u00e9sultat vers votre presse-papiers ou gestionnaire de mots de passe.</li></ol>",
        heading3: "Cas d'utilisation courants",
        p3: "<ul><li><strong>S\u00e9curit\u00e9 des comptes :</strong> G\u00e9n\u00e9rer des mots de passe uniques \u00e0 haute entropie pour chaque service en ligne que vous utilisez.</li><li><strong>Administration syst\u00e8me :</strong> Cr\u00e9er des mots de passe temporaires s\u00e9curis\u00e9s pour les nouveaux utilisateurs ou les comptes de service.</li><li><strong>Protection de la vie priv\u00e9e :</strong> Utiliser des alias Plus (ex. : utilisateur+service@domaine.com) pour suivre quels services vendent vos donn\u00e9es ou pour filtrer le spam.</li><li><strong>S\u00e9curit\u00e9 m\u00e9morable :</strong> Utiliser le g\u00e9n\u00e9rateur de phrases de passe pour les mots de passe ma\u00eetres qui doivent \u00eatre tap\u00e9s manuellement mais r\u00e9sistent au d\u00e9chiffrage.</li></ul>",
        heading4: "Conseils de pro",
        p4: "<ul><li><strong>Utilisez un gestionnaire de mots de passe :</strong> N'essayez jamais de m\u00e9moriser des mots de passe complexes. Utilisez cet outil pour les g\u00e9n\u00e9rer et les stocker dans un gestionnaire de mots de passe r\u00e9put\u00e9 comme Bitwarden, 1Password ou KeePassXC.</li><li><strong>L'entropie plut\u00f4t que la complexit\u00e9 :</strong> La longueur est souvent plus importante que la vari\u00e9t\u00e9 des caract\u00e8res. Un mot de passe de 20 caract\u00e8res en minuscules est souvent plus difficile \u00e0 d\u00e9chiffrer qu'un de 8 caract\u00e8res complexe.</li><li><strong>Rotation en cas de violation :</strong> Si un service que vous utilisez est compromis, utilisez ce g\u00e9n\u00e9rateur pour cr\u00e9er imm\u00e9diatement un nouveau mot de passe compl\u00e8tement diff\u00e9rent.</li></ul>",
        heading5: "Qu'est-ce qui rend un mot de passe s\u00e9curis\u00e9 ?",
        p5: "<p>Un mot de passe s\u00e9curis\u00e9 est votre premi\u00e8re ligne de d\u00e9fense contre les acc\u00e8s non autoris\u00e9s. \u00c0 l'\u00e8re du calcul haute vitesse, la s\u00e9curit\u00e9 est d\u00e9finie par l'<strong>entropie</strong> \u2014 la mesure de l'al\u00e9atoire et de l'impr\u00e9visibilit\u00e9 d'une cha\u00eene. Un mot de passe fort doit \u00eatre long (au moins 16 caract\u00e8res), unique pour chaque compte, et compos\u00e9 d'un ensemble diversifi\u00e9 de types de caract\u00e8res incluant majuscules, minuscules, chiffres et symboles.</p><p>\u00c9vitez d'utiliser des informations personnelles comme les dates de naissance, les noms d'animaux ou les mots courants du dictionnaire. M\u00eame des substitutions d'apparence complexe comme P@ssw0rd123 sont facilement d\u00e9chiffr\u00e9es par des outils modernes de force brute qui utilisent de vastes dictionnaires de motifs courants.</p>",
        heading6: "L'entropie expliqu\u00e9e",
        p6: "<p>L'entropie est une mesure de l'al\u00e9atoire et de l'impr\u00e9visibilit\u00e9 d'un mot de passe, exprim\u00e9e g\u00e9n\u00e9ralement en bits. Plus l'entropie est \u00e9lev\u00e9e, plus le mot de passe est fort. Par exemple, un mot de passe de 10 caract\u00e8res utilisant uniquement des lettres minuscules a une entropie bien inf\u00e9rieure \u00e0 un mot de passe de 10 caract\u00e8res utilisant un ensemble complet de caract\u00e8res alphanum\u00e9riques et sp\u00e9ciaux.</p><p>Notre g\u00e9n\u00e9rateur calcule l'entropie en temps r\u00e9el pour vous donner une mesure objective de la force de votre mot de passe. Un mot de passe avec plus de 100 bits d'entropie est consid\u00e9r\u00e9 comme exceptionnellement fort et r\u00e9sistant aux techniques modernes de d\u00e9chiffrage.</p>",
        heading7: "Meilleures pratiques",
        p7: "<ul><li><strong>Ne r\u00e9utilisez jamais les mots de passe :</strong> Utilisez un mot de passe unique pour chaque compte. Si un service est compromis, vos autres comptes restent s\u00e9curis\u00e9s.</li><li><strong>Utilisez un gestionnaire de mots de passe :</strong> Comme les humains ne peuvent pas m\u00e9moriser des dizaines de mots de passe complexes et uniques, utilisez un gestionnaire de mots de passe r\u00e9put\u00e9 pour les stocker en toute s\u00e9curit\u00e9.</li><li><strong>Activez l'AMF :</strong> L'authentification multifacteur ajoute une deuxi\u00e8me couche de s\u00e9curit\u00e9 critique m\u00eame si votre mot de passe est compromis.</li><li><strong>\u00c9vitez les informations personnelles :</strong> N'incluez jamais de noms, dates de naissance ou mots courants que l'on peut trouver dans un dictionnaire.</li></ul>",
        heading8: "Conseils de pro",
        p8: "<ul><li>Utilisez le mode Phrase de passe pour les comptes que vous devez taper manuellement ; elles sont plus faciles \u00e0 retenir mais restent tr\u00e8s s\u00e9curis\u00e9es.</li><li>Pour une s\u00e9curit\u00e9 maximale, g\u00e9n\u00e9rez le mot de passe le plus long autoris\u00e9 par le service (souvent 64 ou 128 caract\u00e8res).</li><li>Auditez r\u00e9guli\u00e8rement vos mots de passe enregistr\u00e9s en utilisant les fonctionnalit\u00e9s de v\u00e9rification de s\u00e9curit\u00e9 int\u00e9gr\u00e9es de votre gestionnaire de mots de passe.</li><li>Envisagez d'utiliser des alias Plus (ex. : utilisateur+service@gmail.com) pour suivre quels services vendent vos donn\u00e9es ou envoient du spam.</li></ul>",
      },
    },
    "hash-calculator": {
      ...
      ui: {
        ...
        button1: "📁 File",
        button2: "✓ Verify",
        button3: "Generate Hash",
        button4: "Clear",
        button5: "Remove",
        button6: "Process File",
        button7: "Verify Integrity",
        button8: "Copy",
        label9: "Input Text",
        label10: "HMAC Secret (Optional)",
        label11: "Expected Hash",
        label12: "Hash Results",
        placeholder13: "Enter text to hash...",
        placeholder14: "Enter secret key...",
        placeholder15: "Paste hash to verify...",
        heading16: "Security Notice",
        desc17: "Drop file here",
        desc18: "or click to browse",
    ...
    "cidr-calculator": {
      ...
      ui: {
        button0: "2001:db8::/32",
        button1: "Run analysis",
        button2: "Reset",
        button3: "Calculate ideal prefix",
        label4: "Network or host",
        label5: "Required hosts",
        ...
        th13: "Range",
        th14: "Usable hosts",
        heading15: "Quick host fit",
        heading16: "Validation",
        heading17: "Detailed breakdown",
        heading18: "Binary & Hex",
        heading19: "Neighboring Prefixes",
        heading20: "Subnet Explorer",
        heading21: "IP Address Formats",
        desc32: "View the network address in multiple formats.",
        desc33: "Decimal Dotted",
        desc34: "Binary",
        desc35: "Hexadecimal",
        desc36: "Integer (Decimal)",
        desc37: "IPv4-mapped IPv6",
        desc38: "IPv6 Expanded",
        desc39: "IPv6 Compressed",
        desc40: "Reverse DNS (PTR)",
        title0: "Copy to clipboard",
        desc21: "Specify a prefix if your input omits it.",
        desc22: "Network ID",
        desc23: "Prefix —",
        desc24: "Address range",
        desc25: "First · Last",
        desc26: "Capacity",
        desc27: "Classification",
        desc28: "Expanded",
        desc29: "Bit pattern",
        desc30: "Split the analyzed block into smaller CIDRs.",
        desc31: "Select a prefix to preview subnets.",
        label32: "IPv4",
        label33: "IPv6",
        badge34: "Zero Upload",
        badge35: "IPv4 & IPv6",
        badge36: "Client-Side Only",
        badge37: "Privacy First",
        th18: "Subnet Mask",
        th19: "Hosts",
        th20: "Use Case",
        th21: "Class",
      ...
      js: {
        ...
        text1: "Choose a prefix deeper than the analyzed block.",
        text2: "Total subnets:",
      ...
      cheatsheet: {
        ...
        h1: "Plages priv\u00e9es (RFC 1918)",
        c0: '<table> <tr><th>CIDR</th><th data-i18n="tools.cidr-calculator.ui.th18">Masque de sous-r\u00e9seau</th><th data-i18n="tools.cidr-calculator.ui.th19">H\u00f4tes</th><th data-i18n="tools.cidr-calculator.ui.th20">Cas d\'utilisation</th></tr> <tr><td><code>/32</code></td><td>255.255.255.255</td><td>1</td><td>H\u00f4te unique</td></tr> <tr><td><code>/24</code></td><td>255.255.255.0</td><td>254</td><td>Petit r\u00e9seau</td></tr> <tr><td><code>/16</code></td><td>255.255.0.0</td><td>65,534</td><td>R\u00e9seau moyen</td></tr> <tr><td><code>/8</code></td><td>255.0.0.0</td><td>16M+</td><td>Grand r\u00e9seau</td></tr> </table>',
        c1: '<table> <tr><th data-i18n="tools.cidr-calculator.ui.th13">Plage</th><th>CIDR</th><th data-i18n="tools.cidr-calculator.ui.th21">Classe</th></tr> <tr><td>10.0.0.0 \u2013 10.255.255.255</td><td><code>10.0.0.0/8</code></td><td>A</td></tr> <tr><td>172.16.0.0 \u2013 172.31.255.255</td><td><code>172.16.0.0/12</code></td><td>B</td></tr> <tr><td>192.168.0.0 \u2013 192.168.255.255</td><td><code>192.168.0.0/16</code></td><td>C</td></tr> </table>',
      },
    },
    "dns-reference": {
      name: "Référence DNS",
    ...
    "bandwidth-calculator": {
      ...
      ui: {
        ...
        badge54: "Client-Side Only",
        badge55: "Privacy First",
        label0: "Unit System:",
    ...
    "wireshark-filter": {
      ...
      ui: {
        ...
        badge52: "Client-Side Only",
        badge53: "Privacy First",
        label0: "Protocol",
        label1: "Field",
        label2: "Operator",
        label3: "Value",
    ...
    "protocol-headers": {
      ...
      ui: {
        ...
        badge19: "7 Protocols",
        badge20: "Hex Parser",
        badge21: "Client-Side Only",
        badge22: "Privacy First",
    ...
    "text-diff": {
      ...
      ui: {
        button0: "Compare Texts",
        placeholder1: "Enter original text...",
        placeholder2: "Enter modified text...",
        heading3: "Original Text",
        heading4: "Modified Text",
        heading5: "Differences",
        desc6: "No differences found (or empty input)",
    ...
    "regex-visualizer": {
      ...
      ui: {
        ...
        button1: "Python",
        button2: "Java",
        label3: "Regular Expression",
        label4: "Test String",
        label5: "Code Snippet",
        placeholder6: "Enter text to test against...",
        title7: "Copy code",
        stat8: "Match #",
        stat9: "Full Match",
        stat10: "Groups",
        stat11: "Index",
        heading12: "Explanation",
        desc13: "g (global)",
        desc14: "i (insensitive)",
        desc15: "m (multiline)",
        desc16: "2 matches",
        desc17: "No groups",
        badge18: "Visualizer",
      ...
      js: {
        ...
        tpl2: "Code Snippet",
        tpl3: "Index",
        tpl4: "Invalid Regex for Visualization",
        tpl5: "No groups",
    ...
    "universal-decoder": {
      ...
      ui: {
        ...
        stat8: "Quick Samples",
        stat9: "Detection Matrix",
        stat10: "Structured Data",
        stat11: "Query Params",
        stat12: "JSON Preview",
        stat13: "Decoding Pipeline",
        stat14: "No query string detected.",
        desc15: "● IDLE",
        desc16: "Confidence",
        desc17: "Layers:",
        desc18: "Format:",
        desc19: "0 BYTES",
        desc20: "AUTO-UPDATED",
        desc21: "No structured content detected yet.",
        desc22: "No operations run yet.",
        desc23: "HEADER & PAYLOAD DECODED",
        badge24: "Client-side processing",
        badge25: "Zero server storage",
        badge26: "Client-Side Only",
        badge27: "Privacy First",
      ...
      js: {
        ...
        text1: "● DECODED",
        text2: "● IDLE [",
        text3: "No operations run yet.",
        text4: "No structured content detected yet.",
        text5: "Provide JSON-like content to preview structure.",
        text6: "✓ COPIED",
        tpl7: "No query string detected.",
      },
    },
    "cron-builder": {
      ...
      ui: {
        ...
        button4: "Week",
        button5: "Copy",
        label6: "Cron Expression",
        heading7: "Next Runs",
        heading8: "Common Recipes",
        desc9: "Every minute (*)",
        desc10: "Specific minutes",
        desc11: "Every hour (*)",
        desc12: "Specific hours",
        desc13: "Every day (*)",
        desc14: "No specific day (?)",
        desc15: "Specific days",
        desc16: "Every month (*)",
        desc17: "Specific months",
        desc18: "Every day of the week (*)",
        desc19: "Specific days of week",
        desc20: "Local Time",
        badge21: "Bi-directional",
        badge22: "Client-Side Only",
        badge23: "Privacy First",
        th0: "Position",
        th1: "Field",
        th2: "Range",
        th3: "Char",
      ...
      js: {
        text0: "Invalid cron expression",
        tpl1: "Common Recipes",
        tpl2: "Invalid expression",
      },
      cheatsheet: {
        title: "R\u00e9f\u00e9rence de syntaxe Cron",
        h0: "Ordre des champs",
        h1: "Caract\u00e8res sp\u00e9ciaux",
        h2: "Exemples courants",
        c0: '<table> <tr><th data-i18n="tools.cron-builder.ui.th0">Position</th><th data-i18n="tools.cron-builder.ui.th1">Champ</th><th data-i18n="tools.cron-builder.ui.th2">Plage</th></tr> <tr><td>1</td><td>Minute</td><td>0\u201359</td></tr> <tr><td>2</td><td>Heure</td><td>0\u201323</td></tr> <tr><td>3</td><td>Jour du mois</td><td>1\u201331</td></tr> <tr><td>4</td><td>Mois</td><td>1\u201312</td></tr> <tr><td>5</td><td>Jour de la semaine</td><td>0\u20137 (0,7 = Dim)</td></tr> </table>',
        c1: '<table> <tr><th data-i18n="tools.cron-builder.ui.th3">Car.</th><th data-i18n="tools.cron-builder.ui.th4">Signification</th><th data-i18n="tools.cron-builder.ui.th5">Exemple</th></tr> <tr><td><code>*</code></td><td>Toute valeur</td><td>Chaque minute</td></tr> <tr><td><code>,</code></td><td>Liste</td><td><code>1,15</code> (1er et 15e)</td></tr> <tr><td><code>-</code></td><td>Plage</td><td><code>1-5</code> (Lun\u2013Ven)</td></tr> <tr><td><code>/</code></td><td>Pas</td><td><code>*/5</code> (toutes les 5 min)</td></tr> </table>',
        c2: '<table> <tr><th data-i18n="tools.cron-builder.ui.th6">Expression</th><th data-i18n="tools.cron-builder.ui.th7">Description</th></tr> <tr><td><code>0 * * * *</code></td><td>Chaque heure</td></tr> <tr><td><code>0 0 * * *</code></td><td>Quotidien \u00e0 minuit</td></tr> <tr><td><code>0 0 * * 1</code></td><td>Chaque lundi</td></tr> <tr><td><code>*/5 * * * *</code></td><td>Toutes les 5 minutes</td></tr> <tr><td><code>0 9-17 * * 1-5</code></td><td>Toutes les heures 9h\u201317h en semaine</td></tr> </table>',
      },
    },
    "ssh-key-generator": {
      ...
      ui: {
        ...
        label2: "Key Type",
        label3: "RSA Key Size",
        label4: "Comment (Optional)",
        placeholder5: "user@host or description",
        option6: "2048 bits (Minimum, faster)",
        option7: "3072 bits (Balanced)",
        ...
        desc15: "⚠️ KEEP THIS PRIVATE! Save with permissions 600.",
        desc16: "Local Machine:",
        desc17: "Remote Server:",
        badge18: "Private & Secure",
        badge19: "Client-Side Only",
        badge20: "Privacy First",
        th7: "Algorithm",
        th8: "Key Size",
        th9: "Security",
        th10: "Use Case",
    ...
    "certificate-decoder": {
      ...
      ui: {
        button0: "Parse Certificate",
        button1: "Clear",
        label2: "Paste Certificate (PEM Format)",
        stat3: "Common Name",
        stat4: "Issuer",
        stat5: "Valid From",
        stat6: "Valid To",
        desc7: "Subject",
        desc8: "expand_more",
        desc9: "Subject Alternative Names (SANs)",
        desc10: "Certificate Details",
        desc11: "Extensions",
        desc12: "No data present.",
        desc13: "No Subject Alternative Names present.",
        desc14: "No extensions parsed.",
        badge15: "Client-Side Only",
        badge16: "Privacy First",
        th4: "Field",
        th5: "Description",
    ...
    "saml-decoder": {
      ...
      ui: {
        ...
        button2: "Copy JSON",
        button3: "Pretty XML",
        button4: "Assertion details",
        button5: "Claims JSON",
        button6: "Copy XML",
        label7: "SAML response",
        placeholder8: "Paste the Base64 value of SAMLResponse or raw XML here",
    ...
    "user-agent-decoder": {
      ...
      ui: {
        button0: "Use This",
        button1: "Chrome on Windows",
        button2: "Safari on macOS",
        button3: "iPhone Safari",
        button4: "Android Chrome",
        button5: "Firefox on Linux",
        button6: "🔍 Parse User-Agent",
        button7: "🗑️ Clear",
        button8: "Copy",
        label9: "User-Agent String",
        label10: "Quick Examples",
        placeholder11: "Paste User-Agent string here...",
        heading12: "🌐 Your Current Browser",
        heading13: "Parsed Information",
        heading14: "Raw Analysis Output",
        desc15: "Version:",
        desc16: "Engine:",
        desc17: "Architecture:",
        desc18: "Vendor:",
        ...
        desc21: "Mobile:",
        desc22: "Tablet:",
        badge23: "Log Analysis",
        badge24: "Client-Side Only",
        badge25: "Privacy First",
      },
      js: {
        text0: "✓ Copied!",
    ...
    "qr-code": {
      ...
      ui: {
        button0: "Generate QR Code",
        button1: "💾 PNG",
        button2: "💾 SVG",
        button3: "Decode QR Code",
        label4: "Text or URL to Encode",
        label5: "Error Correction",
        label6: "Foreground",
        label7: "Background",
        label8: "Preview",
        label9: "Upload Image",
        label10: "Image Preview",
        label11: "Size: 256px",
        placeholder12: "Enter URL, text, or any content...",
        option13: "Low (7%)",
        option14: "Medium (15%)",
        option15: "Quartile (25%)",
        option16: "High (30%)",
        desc17: "upload_file",
        desc18: "PNG, JPG, GIF up to 10MB",
        desc19: "Decoded Text:",
        badge20: "Client-Side Only",
        badge21: "Privacy First",
        tab0: "Generate",
        tab1: "Decode",
      ...
      js: {
        text0: "Generating...",
        alert1: "Please enter text or URL to encode",
        alert2: "No QR code found in the image. Please try another image.",
        alert3: "Copied!",
    ...
    "color-converter": {
      ...
      ui: {
        ...
        label1: "Manual Input",
        label2: "Preview",
        placeholder3: "Enter HEX, RGB, or HSL...",
        desc4: "Supports #hex, rgb(r,g,b), hsl(h,s,l)",
        desc5: "content_copy",
        badge6: "Live Preview",
        badge7: "Client-Side Only",
        badge8: "Privacy First",
      ...
      edu: {
        ...
        heading3: "Cas d'utilisation courants",
        heading4: "Conseils de pro",
        p1: "<p>Les mod\u00e8les de couleur sont des syst\u00e8mes math\u00e9matiques pour repr\u00e9senter les couleurs. <strong>HEX</strong> (Hexad\u00e9cimal) est un code \u00e0 6 chiffres utilis\u00e9 en HTML et CSS, repr\u00e9sentant les composantes Rouge, Vert et Bleu. <strong>RGB</strong> (Rouge, Vert, Bleu) utilise des valeurs d\u00e9cimales de 0 \u00e0 255 pour chaque canal, souvent utilis\u00e9 en imagerie num\u00e9rique.</p><p><strong>HSL</strong> (Teinte, Saturation, Luminosit\u00e9) est plus intuitif pour les humains, car il d\u00e9crit la couleur en termes de son pigment de base (Teinte), d'intensit\u00e9 (Saturation) et de luminosit\u00e9 (Luminosit\u00e9). Comprendre ces mod\u00e8les aide \u00e0 choisir le bon format pour vos besoins de conception et de d\u00e9veloppement, assurant la coh\u00e9rence sur diff\u00e9rentes plateformes et appareils.</p>",
        p2: '<ol><li>Utilisez le s\u00e9lecteur de couleur visuel pour s\u00e9lectionner une couleur en faisant glisser le curseur dans le carr\u00e9 de saturation/luminosit\u00e9 et le curseur de teinte.</li><li>Alternativement, saisissez une valeur sp\u00e9cifique dans le champ "Saisie manuelle" (prend en charge les formats #hex, rgb ou hsl).</li><li>Observez la bo\u00eete "Aper\u00e7u" pour voir la couleur s\u00e9lectionn\u00e9e en temps r\u00e9el.</li><li>Consultez les valeurs converties dans les cartes HEX, RGB, HSL et HSV ci-dessous.</li><li>Cliquez sur l\'ic\u00f4ne "Copier" sur n\'importe quelle carte pour sauvegarder ce format sp\u00e9cifique dans votre presse-papiers.</li></ol>',
        p3: "<ul><li><strong>Design web :</strong> Convertir les couleurs des outils de design (souvent RGB/HSL) en codes HEX pour les feuilles de style CSS.</li><li><strong>Coh\u00e9rence de marque :</strong> S'assurer que les couleurs de votre marque sont repr\u00e9sent\u00e9es avec pr\u00e9cision dans diff\u00e9rents formats num\u00e9riques et m\u00e9dias.</li><li><strong>D\u00e9veloppement UI :</strong> G\u00e9n\u00e9rer rapidement des variations plus claires ou plus sombres d'une couleur de base en ajustant la valeur de Luminosit\u00e9 en HSL.</li><li><strong>Tests d'accessibilit\u00e9 :</strong> Utiliser l'aper\u00e7u pour v\u00e9rifier si les couleurs choisies offrent suffisamment de contraste pour un texte lisible et des \u00e9l\u00e9ments UI.</li></ul>",
        p4: "<ul><li>Utilisez HSL lors de la conception de composants UI comme les boutons, car il est facile de cr\u00e9er des \u00e9tats de survol en ajustant simplement la valeur de luminosit\u00e9.</li><li>Lorsque vous travaillez avec la transparence en CSS, pr\u00e9f\u00e9rez <code>rgba()</code> ou <code>hsla()</code> pour une meilleure lisibilit\u00e9 et un meilleur contr\u00f4le sur le canal alpha.</li><li>V\u00e9rifiez toujours les ratios de contraste des couleurs pour vous assurer que vos conceptions sont accessibles aux utilisateurs malvoyants.</li></ul>",
      },
    },
    "unit-converter": {
      ...
      ui: {
        ...
        label2: "To",
        title3: "Swap Units",
        desc4: "Select units to see the conversion formula",
        badge5: "Client-Side Only",
        badge6: "Privacy First",
      },
      js: {
    ...
    "yaml-toml-converter": {
      ...
      ui: {
        button0: "Load sample",
        button1: "Validate only",
        button2: "→ JSON",
        button3: "→ YAML",
        button4: "→ TOML",
        button5: "Copy",
        label6: "Source format",
      ...
      js: {
        text0: "Copied",
        text1: "Copy",
        text2: "⚠️ Cannot serialize to JSON:",
        text3: "js-yaml not loaded.",
        text4: "⚠️ YAML conversion failed:",
        text5: "TOML stringify not available in this runtime.",
    ...
    "htpasswd-generator": {
      ...
      ui: {
        button0: "Show",
        button1: "Generate strong",
        button2: "Randomize",
        button3: "Generate entry",
        button4: "Copy",
        button5: "Download",
        button6: "Clear",
        label7: "Username",
        ...
        label9: "Algorithm",
        label10: "Salt",
        placeholder11: "deploy",
        placeholder12: "8 chars (./0-9A-Za-z)",
        option13: "Bcrypt (-B)",
    ...
    "mock-data-generator": {
      ...
      ui: {
        ...
        desc11: "Fields",
        desc12: "Select columns to include",
        badge13: "Client-Side Only",
        badge14: "Privacy First",
      ...
      cheatsheet: {
        title: "Types de champs de donn\u00e9es simul\u00e9es",
        h0: "Types disponibles",
        c0: "<table><tr><th>Type</th><th>Exemple de sortie</th></tr><tr><td><code>name</code></td><td>Jean Dupont</td></tr><tr><td><code>email</code></td><td>jean@exemple.com</td></tr><tr><td><code>phone</code></td><td>+33-1-23-45-67-89</td></tr><tr><td><code>address</code></td><td>12 Rue de la Paix</td></tr><tr><td><code>date</code></td><td>2024-03-15</td></tr><tr><td><code>uuid</code></td><td>550e8400-e29b...</td></tr><tr><td><code>number</code></td><td>42</td></tr><tr><td><code>boolean</code></td><td>vrai / faux</td></tr><tr><td><code>url</code></td><td>https://exemple.com</td></tr><tr><td><code>ip</code></td><td>192.168.1.1</td></tr><tr><td><code>color</code></td><td>#ff6b35</td></tr><tr><td><code>company</code></td><td>Soci\u00e9t\u00e9 Exemple SARL</td></tr></table>",
      },
    },
    "markdown-editor": {
      ...
      ui: {
        ...
        button5: "Copy HTML",
        button6: "Download .md",
        button7: "Download .html",
        title8: "Print preview",
        option9: "Jump to heading...",
        desc10: "Markdown",
        badge11: "Live Preview",
        badge12: "Mermaid",
        badge13: "Export",
        badge14: "Client-Side Only",
        badge15: "Privacy First",
    ...
    "log-viewer": {
      ...
      ui: {
        label0: "Log File",
        label1: "Filter",
        placeholder2: "Search logs...",
        title3: "Use Regex",
        stat4: "Log Density",
        desc5: "Select a log file to begin analysis",
        badge6: "100k+ Lines",
        badge7: "Client-Side Only",
        badge8: "Privacy First",
      ...
      js: {
        ...
        text1: "Parsing logs...",
        text2: "Loaded",
        tpl3: "Select a log file to begin analysis",
        text3: "lines",
        text4: "matches",
      },
    },
    "case-converter": {
      ...
      ui: {
        ...
        desc4: "content_copy",
        badge5: "12+ Styles",
        badge6: "Client-Side Only",
        badge7: "Privacy First",
        label1: "characters",
        label2: "words",
        button0: "Clear",
      },
    ...
    "code-minifier": {
      ...
      ui: {
        button0: "JavaScript",
        button1: "🗜️ Minify Code",
        button2: "✨ Beautify Code",
        button3: "🗑️ Clear",
        button4: "📋 Copy",
        button5: "💾 Download",
        placeholder6: "Paste your code here...",
        placeholder7: "Output will appear here...",
        heading8: "📝 Input Code",
        heading9: "✅ Output Code",
    ...
    "image-converter": {
      ...
      ui: {
        button0: "🔄 Convert & Resize Image",
        button1: "💾 Download Converted Image",
        label2: "Resize Mode",
        label3: "Width (px)",
        label4: "Height (px)",
        label5: "Max Width (px)",
        label6: "Max Height (px)",
        option7: "No Resize (Keep Original)",
        option8: "Percentage",
        option9: "Custom Dimensions",
        option10: "Max Width/Height",
        heading11: "📤 Upload Image",
        heading12: "🔄 Convert Format",
        heading13: "📏 Resize Image",
        heading14: "📷 Original Image",
        heading15: "✨ Converted Image",
        heading16: "Multiple Formats",
        heading17: "Flexible Resizing",
        heading18: "Instant Processing",
        desc19: "Drop image here or click to browse",
        desc20: "Supports: PNG, JPG, WebP, GIF",
        desc21: "Lossless",
        desc22: "Smaller size",
        desc23: "Modern",
        desc24: "Animation",
        desc25: "Lower quality = smaller file size",
      ...
      js: {
        alert0: "Please upload a valid image file.",
        alert1: "Failed to load image. The file might be corrupted.",
        alert2: "Error reading file.",
        tpl3: "Client-side processing using Canvas API - no uploads, instant results",
      },
      edu: {
    ...
    "css-gradient": {
      ...
      ui: {
        ...
        option14: "Top Left",
        option15: "Top Right",
        option16: "Bottom Left",
        option17: "Bottom Right",
        heading18: "🔧 Gradient Type",
        heading19: "🎨 Color Stops",
        heading20: "✨ Preset Gradients",
        heading21: "👁️ Live Preview",
        heading22: "📋 CSS Code",
        heading23: "💡 Quick Tips",
        heading24: "🎯 Use Cases",
        badge25: "Client-Side Only",
        badge26: "Privacy First",
      },
    ...
    "curl-studio": {
      ...
      ui: {
        button0: "Parse Command",
        button1: "Generate Curl Command",
        button2: "Copy JSON",
        button3: "Copy Command",
        label4: "Curl Command",
        label5: "Method & URL",
        label6: "Headers (JSON)",
        label7: "Body",
      ...
      js: {
        text0: "Error parsing curl command:",
        text1: "Copied!",
        tpl2: "curl ...",
      },
      cheatsheet: {
    ...
    "log-masker": {
      ...
      ui: {
        ...
        button1: "Copy Result",
        label2: "Raw Logs",
        label3: "Custom Keywords (comma separated)",
        placeholder4: "Paste logs here...",
        placeholder5: "api_key, secret, token",
        heading6: "Redaction Settings",
        heading7: "Masked Logs",
        desc8: "Email Addresses",
        desc9: "IP Addresses",
        desc10: "Credit Card Numbers",
        badge11: "PII Redaction",
        badge12: "Local Only",
        badge13: "Secure",
        badge14: "Client-Side Only",
        badge15: "Privacy First",
    ...
    "json-schema-studio": {
      ...
      ui: {
        button0: "Beautify",
        button1: "Sample",
        button2: "Generate JSON Schema",
        button3: "Copy Schema",
        heading4: "Input JSON",
        heading5: "JSON Schema Result",
        badge6: "Auto-Generator",
        badge7: "JSON Schema",
        badge8: "Privacy-First",
        badge9: "Client-Side Only",
        badge10: "Privacy First",
      ...
      js: {
        text0: "Schema generator failed to load.",
        text1: "Invalid JSON:",
        text2: "Copied!",
        tpl3: "Schema will appear here...",
      },
      cheatsheet: {
    ...
    caffeinate: {
      ...
      ui: {
        status0: "Wake lock is idle. Click below to keep this device awake.",
        button0: "Activate Wake Lock",
        button1: "Deactivate Wake Lock",
        label0: "Mode",
        label1: "Uptime",
        label2: "Heartbeats",
      ...
      js: {
        status0: "Native wake lock active. Your screen will stay awake.",
        status1: "Fallback wake lock active. Keep this tab in the foreground.",
        status2: "Wake lock failed: {{reason}}. Please reactivate manually.",
    ...
    "email-analyzer": {
      ...
      ui: {
        ...
        button1: "Load Sample",
        button2: "Clear",
        button3: "Copy Summary",
        label0: "Raw Email (Headers + Body)",
        label1: "Extract URLs from body",
        label2: "Mask emails/IPs in report",
        label3: "From",
        label4: "To",
        label5: "Subject",
        label6: "Date",
        label7: "Return-Path",
        label8: "Reply-To",
        placeholder0: "Paste the full email source here...",
        heading0: "Identity",
        heading1: "Findings",
        heading2: "URLs",
        heading3: "Routing Hops",
        heading4: "Email Auth Quick Reference",
        heading5: "What these checks mean",
        heading6: "Common header fields",
        th0: "Header",
        th1: "Why it matters",
      ...
      js: {
        ...
        text29: "Non-HTTPS",
        text30: "Invalid URL",
        text31: "Showing first {n} URLs.",
        text32: "No Received headers found.",
        text33: "Showing first {n} Received hops.",
        text34: "Email Security Summary",
        text35: "From: {v}",
        text36: "To: {v}",
        text37: "Subject: {v}",
        text38: "Date: {v}",
        ...
        text49: "Sample loaded. Click Analyze.",
        text50: "Run analysis to see signals and mismatches.",
        text51: "No URLs extracted yet.",
        text52: "No routing data yet.",
      },
      edu: {
    ...
    "token-counter": {
      ...
      ui: {
        ...
        placeholder1: "e.g., 5.00",
        placeholder2: "e.g., 15.00",
        placeholder3: "e.g., 3.00",
        placeholder4: "e.g., 15.00",
        placeholder5: "e.g., 0.50",
        placeholder6: "e.g., 0.75",
        option0: "Balanced",
        option1: "Conservative (+10%)",
        stat0: "Chars",
        stat1: "Bytes (UTF-8)",
        stat2: "Words",
        stat3: "Lines",
        ...
        heading3: "Why counts differ",
        heading4: "How this tool estimates",
        th0: "Family",
        th1: "Input",
        th2: "Output",
        th3: "Total",
    ...
    "prompt-template-builder": {
      ...
      ui: {
        ...
        button4: "Copy Prompt",
        label0: "Target",
        label1: "Output format",
        label2: "Role / persona (system)",
        label3: "Task (what do you want?)",
        label4: "Context (optional)",
        label5: "Variables",
        label6: "Tone",
        label7: "Constraints & do/don’t",
        label8: "Ask clarifying questions first (if needed)",
        label9: "Include injection guardrails",
        label10: "Examples (optional)",
        label11: "System",
        label12: "User",
        label13: "Prompt",
        ...
        option3: "Markdown (recommended)",
        option4: "JSON",
        option5: "Checklist",
        option6: "Custom",
        option7: "Neutral, direct",
        option8: "Concise, high-signal",
        option9: "Teaching / explanatory",
        option10: "Executive summary",
        heading0: "Generated",
        heading1: "Prompt Design Checklist",
        heading2: "High-signal inputs",
        heading3: "Common mistakes",
        text0: "Task",
        text1: "one clear objective",
        text2: "Context",
        text3: "relevant constraints and environment",
        text4: "Format",
      ...
      js: {
        ...
        text3: "Be direct and professional.",
        text4: "Return valid JSON only. Do not wrap in markdown code fences.",
        ...
        text18: "# Context",
        text19: "# Constraints",
        text20: "# Output Format",
        text21: "# Examples / Edge Cases",
        text22: "# Inputs",
        text23: "# Response Requirements",
        text24: "Be correct.",
    ...
    "sql-formatter": {
      ...
      ui: {
        ...
        desc3: "Put",
        desc4: "conditions on separate lines with",
        desc5: ".",
        desc6: "Use explicit",
      ...
      js: {
        ...
        text1: "Unclosed block comment (/* ... */)",
        text2: "Unclosed single-quoted string",
        text3: "Unclosed double-quoted identifier/string",
        text4: "Unclosed backtick-quoted identifier",
        text5: "Unbalanced parentheses: {n}",
        text6: "Query ends with a clause keyword ({kw}). It may be incomplete.",
        text7: "✓ No issues detected by heuristic checks.",
        text8: "Showing first {n} issues.",
    ...
    "env-var-manager": {
      ...
      ui: {
        ...
        button2: "Sample",
        button3: "Clear",
        button4: "Copy Share Report",
        label0: "Environment A",
        label1: "Environment B",
        label2: "Mask sensitive values",
        label3: "Filter keys",
        placeholder0: "API_URL=https://dev.example.com\nJWT_SECRET=...",
        placeholder1: "API_URL=https://example.com\nJWT_SECRET=...",
        placeholder2: "e.g., AWS_, SECRET, DB_",
        placeholder3: "Click Compare to generate...",
        heading0: "Options",
        heading1: "Summary",
        heading2: "Share-safe report",
        heading3: "Diff",
        heading4: "Dotenv Notes",
        heading5: "Masking strategy",
        heading6: "Parsing",
        th0: "Key",
        th1: "Status",
        stat0: "Same",
    ...
    "svg-optimizer": {
      ...
      ui: {
        ...
        heading1: "Preview",
        heading2: "Output SVG",
        heading3: "SVG Safety Notes",
        heading4: "Sanitization",
        stat0: "Input bytes",
        stat1: "Output bytes",
        stat2: "Colors",
        stat3: "ViewBox",
      ...
      js: {
        ...
        text1: "DOMPurify not loaded.",
        text2: "No <svg> root element found.",
        text3: "No explicit colors found (may already use currentColor).",
        text4: "Replace with… (e.g., #000000)",
        text5: "Preview an SVG to extract colors.",
        text6: "Preview failed: invalid SVG output.",
    ...
    "csp-builder": {
      ...
      ui: {
        ...
        heading3: "Baseline recommendations",
        ...
        desc8: "or set to allowed origins",
        desc9: "Prefer",
        desc10: "over",
        ...
        dirHelp: {
          ...
          "style-src": "CSS sources (consider hashes/nonces)",
          "img-src": "Images",
          "connect-src": "XHR/fetch/WebSocket",
          "font-src": "Fonts",
          "frame-src": "Frames/iframes",
          "object-src": "Plugins (usually 'none')",
          "base-uri": "Restrict <base> tag",
          "form-action": "Where forms can POST",
          "frame-ancestors": "Who can embed you",
        },
        dirPlaceholder: {
          "default-src": "e.g., 'self'",
          "script-src": "e.g., 'self' 'nonce-{{nonce}}'",
          "style-src": "e.g., 'self'",
          "img-src": "e.g., 'self' data: https:",
          "connect-src": "e.g., 'self' https://api.example.com",
          "font-src": "e.g., 'self' data:",
          "frame-src": "e.g., 'self'",
          "object-src": "e.g., 'none'",
          "base-uri": "e.g., 'none'",
          "form-action": "e.g., 'self'",
          "frame-ancestors": "e.g., 'none'",
        },
      },
      js: {
        text0:
    ...
    "secret-scanner": {
      ...
      ui: {
        ...
        button1: "Sample",
        button2: "Clear",
        button3: "Copy Redacted",
        label0: "Input",
        label1: "Show full matches (unsafe)",
        label2: "Include low severity patterns",
        label3: "Redacted output (share-safe)",
        placeholder0: "Paste code/config here...",
        placeholder1: "Redacted text will appear here after scanning...",
        stat0: "High",
        stat1: "Medium",
        stat2: "Low",
        heading0: "Findings",
        heading1: "What to do if you find a secret",
      ...
      js: {
        ...
        text1: "Revoke/rotate the key. Treat as compromised.",
        text2: "AWS Access Key ID",
        text3: "Rotate AWS keys and investigate CloudTrail usage.",
        text4: "GitHub token",
        text5: "Revoke the token in GitHub and audit access.",
        text6: "Google API key",
        text7: "Restrict/rotate the key in Google Cloud Console.",
        text8: "Stripe secret key",
        text9: "Roll the key in Stripe and check recent charges/activity.",
        text10: "Slack token",
        ...
        text23: "Input was large; scanned only the first 250,000 characters.",
        text24: "High",
        text25: "Medium",
        text26: "Low",
        text27: "Showing first {n} findings.",
    ...
    "encoding-workbench": {
      ...
      ui: {
        badge0: "Privacy First",
        tab0: "🔄 Encode / Decode",
        tab1: "# Hash",
        tab2: "🔍 Identify",
        label0: "Input",
        label1: "Output",
        placeholder0: "Paste text or encoded data here…",
        op0: "Base64 Encode",
        op1: "Base64 Decode",
        op2: "URL Encode",
        op3: "URL Decode",
        ...
        op6: "Hex Encode",
        op7: "Hex Decode",
        op8: "🔎 Auto-Detect Layers",
        chainLabel: "Detected Encoding Layers",
        decodeAll: "⚡ Decode All Layers",
        copy: "Copy",
        clear: "Clear",
        hashModeText: "📝 Text",
        hashModeFile: "📁 File",
        ...
        dropFileHint: "Processed entirely in your browser",
        remove: "Remove",
        algoLabel: "Algorithms",
        hmacLabel: "HMAC Mode",
        hmacPlaceholder: "Enter HMAC secret key…",
        bcryptLabel: "bcrypt Mode",
        bcryptRoundsLabel: "Cost rounds:",
        option29: "4 (fastest)",
        option30: "10 (recommended)",
        option31: "12 (slowest)",
        hashAll: "Hash All",
        hashResultsLabel: "Hash Results",
        identifyInputLabel: "Unknown Hash or Encoded String",
        identifyPlaceholder: "Paste hash / encoded string here…",
        identifyBtn: "🔍 Identify",
        identifyResults: "Identification Results",
        button10: "Copy",
        decodeThis: "Decode this →",
        verifyHash: "Verify hash →",
        desc0: "No output yet",
        desc1: "Choose an operation above or click Auto-Detect Layers.",
        desc2: "No hashes yet",
        desc3: "Enter text or select a file and click Hash All.",
        desc4: "Nothing identified yet",
        desc5: "Paste a hash or encoded string above and click Identify.",
    ...
    "ladder-game": {
      ...
      ui: {
        ...
        presetCoffeeResult3: "Get treated",
        presetLunchResult0: "Buy lunch",
        presetLunchResult1: "Wash dishes",
        presetLunchResult2: "Free pass",
        presetGiftResult0: "Give a gift",
        presetGiftResult1: "Receive a gift",
        presetGiftResult2: "Exchange gifts",
        presetChoresResult0: "Clean kitchen",
        presetChoresResult1: "Do laundry",
        presetChoresResult2: "Vacuum",
        presetChoresResult3: "Take out trash",
        presetChoresResult4: "Clean bathroom",
        presetChoresResult5: "Free pass",
        presetTeamsResult0: "Team A",
        presetTeamsResult1: "Team B",
        presetTeamsResult2: "Team C",
        presetTeamsResult3: "Team D",
    ...
    "roulette-wheel": {
      ...
      ui: {
        ...
        "segment-placeholder": "Segment name",
        "delete-segment-aria": "Delete segment",
        "add-button": "Add",
        "add-placeholder": "Add new segment...",
        "stats-title": "Statistics",
        "stat-total": "Spins",
        "stat-fairness": "Fairness",
        "history-title": "Recent History",
        "presets-title": "Presets",
        "preset-name-placeholder": "Preset name...",
        "save-preset": "Save",
        "load-preset": "Load",
        "preset-status": "No preset loaded.",
        ...
        "series-title": "Series Mode",
        "start-series": "Start Series",
        "stop-series": "Stop",
        "series-status": "Ready to start series.",
        "series-stopped": "Series stopped",
        "series-complete": "Series complete!",
        "series-progress": "Spin {played} of {total}",
        "tournament-title": "Tournament Mode",
        "start-tournament": "Start Tournament",
        "stop-tournament": "Stop",
        "tournament-status": "Ready to start tournament.",
        "need-two": "Need at least 2 segments",
        "tournament-running": "Tournament running...",
        "tournament-stopped": "Tournament stopped",
        "tournament-complete": "Tournament complete!",
        bracketRemaining: "Remaining",
        bracketWinners: "Advancing",
        presetBuiltinQuick: "Quick Decision",
        presetBuiltinYesNo: "Yes / No / Maybe",
        presetBuiltinLunch: "Lunch Vote",
        presetBuiltinTeams: "Team Shuffle",
        presetOptionOne: "Option 1",
        presetOptionTwo: "Option 2",
        presetOptionThree: "Option 3",
        presetOptionFour: "Option 4",
        presetOptionAlpha: "Alpha",
        presetOptionBravo: "Bravo",
        presetOptionCharlie: "Charlie",
        presetOptionDelta: "Delta",
        presetOptionYes: "Yes",
        presetOptionNo: "No",
        presetOptionMaybe: "Maybe",
        presetOptionRamen: "Ramen",
        presetOptionPizza: "Pizza",
        presetOptionTacos: "Tacos",
        presetOptionSalad: "Salad",
        presetOptionTeamRed: "Team Red",
        presetOptionTeamBlue: "Team Blue",
        presetOptionTeamGreen: "Team Green",
        presetOptionTeamGold: "Team Gold",
      ...
      js: {
        modeEqualActive: "Equal mode active",
        modeWeightedActive: "Weighted mode active",
        fairnessGood: "Good",
        fairnessFair: "Fair",
        fairnessUneven: "Uneven",
        noSegments: "No segments",
        unknownSegment: "Unknown",
        noSpinsYet: "No spins yet",
        bracketAwaiting: "Start a tournament to populate the bracket.",
    ...
    "marble-roulette": {
      ...
      ui: {
        ...
        text3: "—",
        heading2: "Fairness",
        desc0: "Each drop randomizes start positions using Web Crypto.",
        heading3: "Controls",
        label0: "Names / options",
        placeholder0: "Alice&#10;Bob&#10;Charlie&#10;Dave",
        desc1: "Enter 2–10 names (one per line or comma-separated).",
        label2: "Speed",
        button0: "1x",
        button1: "2x",
        button2: "3x",
        desc2: "Higher speed runs the simulation faster.",
        button3: "Start",
        button4: "Reset",
        heading4: "Result",
        text4: "🏁 Ranking",
        button5: "Drop Again",
        button6: "Remove Winner & Drop",
        button7: "New Draw",
        desc3: "Tip: share by adding ?names=Alice,Bob&autostart=true.",
        heading5: "Statistics",
        button8: "Clear Stats",
        text5: "No drops yet — press Start.",
        heading8: "Winner",
        ...
        themeArc: "Arc Sprint",
        themeChaos: "Chaos Funnel",
        targetFirst: "First to finish",
        targetLast: "Last to finish",
      ...
      js: {
        text0: "—",
        text1: "Ready.",
        err0: "Enter at least 2 names.",
        err1: "Max 10 names.",
        text2: "Dropping...",
        text3: "No finishes yet.",
        text4: "Race finished.",
        text5: "Winner found!",
        text6: "Time up — ranking by progress.",
        text7: "Drops:",
