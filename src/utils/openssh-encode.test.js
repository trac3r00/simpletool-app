...
const ecdsaVector = {
  x: hexToBytes(
    "6e024a1a8bfc2206613e305ae8b466454166594cbae05c51b686c17a968f2a70",
  ),
  y: hexToBytes(
    "4b6e96cdcdb85b833e4dfa468688da61a19e32e2dc9fe314d19896b8347c3fb6",
  ),
  expected:
    "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBG4CShqL/CIGYT4wWui0ZkVBZllMuuBcUbaGwXqWjypwS26Wzc24W4M+TfpGhojaYaGeMuLcn+MU0ZiWuDR8P7Y=",
};
...
const rsaVector = {
  ...
  expected:
    "ssh-rsa ",
};
...
describe("encodeOpenSSHPublicKey", () => {
  it("encodes ECDSA P-256 public keys in OpenSSH wire format", () => {
    ...
    expect(
      encoded.startsWith("ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTY"),
    ).toBe(true);
  });
