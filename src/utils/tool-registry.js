...
export const TOOLS = [
  ...
  },
  {
    ...
    category: "network",
    keywords:
      "ip, subnet, mask, network, binary, hex, integer, ptr, reverse dns, ipv6 mapped, format conversion",
  ...
  },
  {
    ...
    icon: "🧩",
    description:
      "Visualize, explain, and test regular expressions with real-time diagrams.",
  ...
  },
  {
    ...
    icon: "🧩",
    description:
      "Generate reusable prompt templates with placeholders and guardrails.",
  ...
  },
  {
    ...
    icon: "🗄️",
    description:
      "Format SQL and catch common syntax issues (Postgres/MySQL-friendly).",
    path: "/sql-formatter",
    category: "formatters",
