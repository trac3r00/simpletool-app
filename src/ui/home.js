...
<body class="bg-surface-50 text-surface-900 dark:bg-surface-950 dark:text-surface-50 transition-colors duration-200 flex flex-col min-h-screen">
  ...
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16 flex-grow">
    ...
    <div id="favorites-section" class="hidden space-y-6">
      <div class="flex items-center gap-3">
        ...
        <h2 class="text-xl font-bold text-surface-900 dark:text-surface-100 uppercase tracking-wide" data-i18n="home.favorites">Favorites</h2>
    ...
    <div id="recent-section" class="hidden space-y-6">
      <div class="flex items-center gap-3">
        ...
        <h2 class="text-xl font-bold text-surface-900 dark:text-surface-100 uppercase tracking-wide" data-i18n="home.recentlyUsed">Recently Used</h2>
  ...
  <script>
    (function() {
      ...
      var allTools = ${JSON.stringify(tools.map(t => ({ id: t.id, name: t.name, path: t.path, icon: t.icon, description: t.description, badge: t.badge || '' })))};
      var toolMap = {};
