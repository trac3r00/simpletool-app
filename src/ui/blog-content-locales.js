...
const BLOG_LOCALE_OVERRIDES = {
  ko: {
    ...
    "what-is-json": {
      ...
      description:
        "JSON의 구조, 기본 타입, 실무에서의 선택 기준, 그리고 자주 겪는 실수를 한 번에 정리합니다.",
      readingTime: "12분 읽기",
      content: `
    ...
    "understanding-hashes": {
      ...
      description:
        "해시 함수의 성질, 충돌 위험, 그리고 어떤 알고리즘을 언제 써야 하는지 정리합니다.",
      readingTime: "12분 읽기",
      content: `
    ...
    "regex-guide": {
      ...
      description:
        "정규식의 기본 요소, 흔한 패턴, 성능 함정, 그리고 디버깅 방법을 실전 중심으로 정리합니다.",
      readingTime: "14분 읽기",
      content: `
    ...
    "curl-essentials": {
      ...
      description:
        "API 디버깅, 인증, 세션 처리, 자동화에 필요한 cURL 핵심 패턴을 정리합니다.",
      readingTime: "12분 읽기",
      content: `
    ...
    "csp-implementation-guide": {
      ...
      description:
        "XSS 방어를 위해 CSP를 안전하게 도입하고, nonce, hash, report-only를 올바르게 쓰는 방법을 다룹니다.",
      readingTime: "10분 읽기",
      content: `
  ...
  ja: {
    ...
    "what-is-json": {
      ...
      description:
        "JSON の構造、基本型、実務での使い分け、そしてありがちなミスをまとめて理解できます。",
      readingTime: "12分",
      content: `
    ...
    "understanding-hashes": {
      ...
      description:
        "ハッシュ関数の性質、衝突リスク、そして用途に応じたアルゴリズム選択を整理します。",
      readingTime: "12分",
      content: `
    ...
    "regex-guide": {
      ...
      description:
        "正規表現の基礎、よくあるパターン、性能の落とし穴、そしてデバッグ方法を実践的にまとめます。",
      readingTime: "14分",
      content: `
    ...
    "curl-essentials": {
      ...
      description:
        "API デバッグ、認証、セッション、自動化に必要な cURL の基本パターンを整理します。",
      readingTime: "12分",
      content: `
    ...
    "csp-implementation-guide": {
      ...
      description:
        "XSS を防ぐために CSP を安全に導入し、nonce, hash, report-only を正しく使う方法を解説します。",
      readingTime: "10分",
      content: `
  ...
  "zh-CN": {
    ...
    "what-is-json": {
      ...
      description:
        "一次性梳理 JSON 的结构、基本类型、与 XML/YAML 的对比以及常见的解析错误。",
      readingTime: "12 分钟阅读",
      content: `
    ...
    "regex-guide": {
      title: "正则表达式完全指南：实战版",
      description:
        "从实践角度梳理正则表达式的基本要素、常用模式、性能陷阱和调试方法。",
      readingTime: "14 分钟阅读",
      content: `
    ...
    "curl-essentials": {
      ...
      description:
        "梳理 API 调试、认证、会话处理和自动化所需的核心 cURL 用法。",
      readingTime: "12 分钟阅读",
      content: `
    ...
    "csp-implementation-guide": {
      ...
      description:
        "介绍如何安全引入 CSP 以防御 XSS，以及正确使用 nonce、hash 和 report-only 的方法。",
      readingTime: "10 分钟阅读",
      content: `
  ...
  "zh-TW": {
    ...
    "what-is-json": {
      ...
      description:
        "一次性梳理 JSON 的結構、基本型別、與 XML/YAML 的比較以及常見的解析錯誤。",
      readingTime: "12 分鐘閱讀",
      content: `
    ...
    "regex-guide": {
      title: "正規表示式完全指南：實戰版",
      description:
        "從實踐角度梳理正規表示式的基本要素、常用模式、效能陷阱和除錯方法。",
      readingTime: "14 分鐘閱讀",
      content: `
    ...
    "curl-essentials": {
      ...
      description:
        "梳理 API 除錯、驗證、工作階段處理和自動化所需的核心 cURL 用法。",
      readingTime: "12 分鐘閱讀",
      content: `
    ...
    "csp-implementation-guide": {
      ...
      description:
        "介紹如何安全引入 CSP 以防禦 XSS，以及正確使用 nonce、hash 和 report-only 的方法。",
      readingTime: "10 分鐘閱讀",
      content: `
  ...
  fr: {
    ...
    "what-is-json": {
      ...
      description:
        "Structure, types de base, différences avec XML/YAML et erreurs courantes : tout ce qu'il faut savoir sur JSON.",
    ...
    "understanding-hashes": {
      ...
      description:
        "Propriétés des fonctions de hachage, risques de collision et guide pour choisir le bon algorithme selon l'usage.",
      readingTime: "12 min de lecture",
      content: `
    ...
    "regex-guide": {
      ...
      description:
        "Éléments de base, motifs courants, pièges de performance et méthodes de débogage des expressions régulières.",
    ...
    "curl-essentials": {
      ...
      description:
        "Les motifs cURL indispensables pour déboguer les API, gérer l'authentification, les sessions et l'automatisation.",
      readingTime: "12 min de lecture",
      content: `
    ...
    "csp-implementation-guide": {
      ...
      description:
        "Comment déployer CSP de façon sécurisée pour se défendre contre XSS, avec nonce, hash et report-only.",
  ...
  de: {
    ...
    "what-is-json": {
      ...
      description:
        "Struktur, Grundtypen, Unterschiede zu XML/YAML und häufige Parsing-Fehler — alles über JSON auf einen Blick.",
    ...
    "understanding-hashes": {
      ...
      description:
        "Eigenschaften von Hash-Funktionen, Kollisionsrisiken und eine Anleitung zur Wahl des richtigen Algorithmus.",
      readingTime: "12 Min. Lesezeit",
      content: `
    ...
    "regex-guide": {
      title:
        "Der vollständige Leitfaden zu Regular Expressions: Praxis-Edition",
      description:
        "Grundbausteine, häufige Muster, Performance-Fallstricke und Debugging-Methoden für reguläre Ausdrücke.",
    ...
    "curl-essentials": {
      ...
      description:
        "Die wichtigsten cURL-Muster für API-Debugging, Authentifizierung, Session-Handling und Automatisierung.",
      readingTime: "12 Min. Lesezeit",
      content: `
    ...
    "csp-implementation-guide": {
      ...
      description:
        "Wie Sie CSP zum Schutz gegen XSS sicher einführen und nonce, hash sowie report-only richtig einsetzen.",
  ...
  pt: {
    ...
    "what-is-json": {
      ...
      description:
        "Estrutura, tipos básicos, diferenças em relação a XML/YAML e erros comuns de parsing — tudo sobre JSON de uma vez.",
    ...
    "understanding-hashes": {
      ...
      description:
        "Propriedades das funções de hash, riscos de colisão e um guia para escolher o algoritmo certo para cada uso.",
      readingTime: "12 min de leitura",
      content: `
    ...
    "regex-guide": {
      ...
      description:
        "Elementos básicos, padrões comuns, armadilhas de performance e métodos de debug de expressões regulares.",
    ...
    "curl-essentials": {
      ...
      description:
        "Os padrões cURL essenciais para debug de APIs, autenticação, gerenciamento de sessões e automação.",
      readingTime: "12 min de leitura",
      content: `
    ...
    "csp-implementation-guide": {
      ...
      description:
        "Como implementar CSP de forma segura para se defender contra XSS, com nonce, hash e report-only.",
  ...
  vi: {
    ...
    "what-is-json": {
      ...
      description:
        "Cấu trúc, kiểu dữ liệu cơ bản, so sánh với XML/YAML và các lỗi phân tích phổ biến — tất cả về JSON trong một bài.",
    ...
    "understanding-hashes": {
      ...
      description:
        "Các đặc tính của hàm băm, rủi ro va chạm và hướng dẫn chọn thuật toán phù hợp theo mục đích.",
      readingTime: "12 phút đọc",
      content: `
    ...
    "regex-guide": {
      ...
      description:
        "Các yếu tố cơ bản, mẫu phổ biến, bẫy hiệu suất và phương pháp gỡ lỗi biểu thức chính quy.",
    ...
    "curl-essentials": {
      ...
      description:
        "Các mẫu cURL cốt lõi cho gỡ lỗi API, xác thực, quản lý phiên và tự động hóa.",
      readingTime: "12 phút đọc",
      content: `
    ...
    "csp-implementation-guide": {
      ...
      description:
        "Cách triển khai CSP an toàn để phòng thủ XSS, với nonce, hash và report-only.",
