  ...
  ko: [
    {
      id: "q1",
      category: "일반",
      question: "SimpleTool은 무엇이고 누가 사용하면 좋나요?",
      answer:
    ...
    },
    {
      id: "q7",
      category: "보안 및 암호화",
      question: "정말 안전한 비밀번호의 조건은 무엇인가요?",
      answer:
    ...
    },
    {
      id: "q8",
      category: "보안 및 암호화",
      question: "MD5, SHA-256, SHA-512의 차이는 무엇인가요?",
      answer:
    ...
    },
    {
      id: "q9",
      category: "보안 및 암호화",
      question: "왜 MD5는 깨진 알고리즘으로 취급되나요?",
      answer:
    ...
    },
    {
      id: "q11",
      category: "보안 및 암호화",
      question: "비밀번호 해싱에서 bcrypt와 Argon2는 어떻게 다른가요?",
      answer:
    ...
    },
    {
      id: "q13",
      category: "보안 및 암호화",
      question: "해시 체크섬으로 파일 무결성을 어떻게 검증하나요?",
      answer:
    ...
    },
    {
      id: "q14",
      category: "보안 및 암호화",
      question: "CSP(Content Security Policy)는 무엇이고 왜 중요한가요?",
      answer:
    ...
    },
    {
      id: "q15",
      category: "데이터 포맷",
      question: "JSON과 YAML의 차이는 무엇인가요?",
      answer:
    ...
    },
    {
      id: "q17",
      category: "데이터 포맷",
      question: "Base64 인코딩은 무엇이고 언제 쓰나요?",
      answer:
    ...
    },
    {
      id: "q19",
      category: "데이터 포맷",
      question: "여러 타임스탬프 형식은 어떻게 변환하나요?",
      answer:
    ...
    },
    {
      id: "q21",
      category: "데이터 포맷",
      question: "JSON Schema는 무엇이고 왜 써야 하나요?",
      answer:
    ...
    },
    {
      id: "q22",
      category: "데이터 포맷",
      question: "두 텍스트 파일의 차이는 어떻게 비교하나요?",
      answer:
    ...
    },
    {
      id: "q23",
      category: "네트워크 및 웹",
      question: "CIDR 서브넷과 IP 범위는 어떻게 동작하나요?",
      answer:
    ...
    },
    {
      id: "q24",
      category: "네트워크 및 웹",
      question: "User-Agent 문자열에는 어떤 정보가 들어 있나요?",
      answer:
    ...
    },
    {
      id: "q25",
      category: "네트워크 및 웹",
      question: "API 디버깅에 cURL은 어떻게 사용하나요?",
      answer:
    ...
    },
    {
      id: "q26",
      category: "네트워크 및 웹",
      question: "SAML은 무엇이며 SSO는 어떻게 동작하나요?",
      answer:
    ...
    },
    {
      id: "q27",
      category: "네트워크 및 웹",
      question: "이메일 보안에서 SPF, DKIM, DMARC는 무엇인가요?",
      answer:
    ...
    },
    {
      id: "q28",
      category: "개발 생산성",
      question: "LLM API 토큰 비용은 어떻게 추정하나요?",
      answer:
    ...
    },
    {
      id: "q29",
      category: "개발 생산성",
      question: "크론 표현식은 무엇이고 어떻게 작성하나요?",
      answer:
    ...
    },
    {
      id: "q30",
      category: "개발 생산성",
      question: "AI용 프롬프트 템플릿은 어떻게 잘 만드나요?",
      answer:
  ...
  ja: [
    {
      id: "q1",
      category: "一般",
      question: "SimpleTool とは何で、誰向けですか？",
      answer:
    ...
    },
    {
      id: "q4",
      category: "一般",
      question: "データは安全ですか？ クライアントサイド処理はどう動きますか？",
      answer:
    ...
    },
    {
      id: "q8",
      category: "セキュリティと暗号",
      question: "MD5、SHA-256、SHA-512 の違いは何ですか？",
      answer:
    ...
    },
    {
      id: "q9",
      category: "セキュリティと暗号",
      question: "なぜ MD5 は壊れていると見なされるのですか？",
      answer:
    ...
    },
    {
      id: "q11",
      category: "セキュリティと暗号",
      question: "パスワードハッシュでは bcrypt と Argon2 はどう違いますか？",
      answer:
    ...
    },
    {
      id: "q13",
      category: "セキュリティと暗号",
      question: "ハッシュチェックサムでファイル整合性を確認するには？",
      answer:
    ...
    },
    {
      id: "q14",
      category: "セキュリティと暗号",
      question: "CSP（Content Security Policy）とは何で、なぜ重要ですか？",
      answer:
    ...
    },
    {
      id: "q17",
      category: "データ形式",
      question: "Base64 エンコードとは何で、いつ使われますか？",
      answer:
    ...
    },
    {
      id: "q19",
      category: "データ形式",
      question: "異なるタイムスタンプ形式はどう変換しますか？",
      answer:
    ...
    },
    {
      id: "q21",
      category: "データ形式",
      question: "JSON Schema とは何で、なぜ使うべきですか？",
      answer:
    ...
    },
    {
      id: "q22",
      category: "データ形式",
      question: "2 つのテキストファイルの違いはどう比較しますか？",
      answer:
        "追加、削除、変更を並べて見せる diff ツールを使うのが最適です。大きなファイルを目視で比べるより、ずっと速くて安全です。",
    },
    {
      id: "q23",
      category: "ネットワークと Web",
      question: "CIDR サブネットと IP 範囲はどう動きますか？",
      answer:
    ...
    },
    {
      id: "q24",
      category: "ネットワークと Web",
      question: "User-Agent 文字列にはどんな情報が入っていますか？",
      answer:
    ...
    },
    {
      id: "q25",
      category: "ネットワークと Web",
      question: "API デバッグに cURL をどう使いますか？",
      answer:
    ...
    },
    {
      id: "q26",
      category: "ネットワークと Web",
      question: "SAML とは何で、SSO はどう動きますか？",
      answer:
    ...
    },
    {
      id: "q27",
      category: "ネットワークと Web",
      question: "メールセキュリティの SPF、DKIM、DMARC とは何ですか？",
      answer:
    ...
    },
    {
      id: "q28",
      category: "開発生産性",
      question: "LLM API のトークンコストはどう見積もりますか？",
      answer:
    ...
    },
    {
      id: "q29",
      category: "開発生産性",
      question: "cron 式とは何で、どう書けばよいですか？",
      answer:
    ...
    },
    {
      id: "q30",
      category: "開発生産性",
      question: "AI 向けの良いプロンプトテンプレートはどう作りますか？",
      answer:
  ...
  es: [
    {
      id: "q1",
      category: "General",
      question: "¿Qué es SimpleTool y para quién está pensado?",
      answer:
    ...
    },
    {
      id: "q2",
      category: "General",
      question: "¿SimpleTool es realmente gratis?",
      answer:
    ...
    },
    {
      id: "q6",
      category: "General",
      question: "¿Puedo usar SimpleTool sin conexión?",
      answer:
    ...
    {
      id: "q7",
      category: "Seguridad y criptografía",
    ...
    },
    {
      id: "q8",
      category: "Seguridad y criptografía",
      question: "¿Cuál es la diferencia entre MD5, SHA-256 y SHA-512?",
      answer:
    ...
    },
    {
      id: "q9",
      category: "Seguridad y criptografía",
      question: "¿Por qué se considera roto MD5?",
      answer:
    ...
    },
    {
      id: "q10",
      category: "Seguridad y criptografía",
      question: "¿Qué es HMAC y cuándo debería usarlo?",
      answer:
    ...
    },
    {
      id: "q12",
      category: "Seguridad y criptografía",
      question: "¿Qué es un JWT y cuándo debería usarlo?",
      answer:
    ...
    },
    {
      id: "q14",
      category: "Seguridad y criptografía",
      question: "¿Qué es Content Security Policy (CSP) y por qué importa?",
      answer:
    ...
    },
    {
      ...
      question: "¿Cuál es la diferencia entre JSON y YAML?",
      answer:
    ...
    },
    {
      id: "q17",
      category: "Formatos de datos",
      question: "¿Qué es la codificación Base64 y cuándo se usa?",
      answer:
    ...
    },
    {
      id: "q19",
      category: "Formatos de datos",
      question: "¿Cómo convierto entre distintos formatos de timestamp?",
      answer:
    ...
    },
    {
      id: "q20",
      category: "Formatos de datos",
      question: "¿Qué es un UUID y cuándo debería usarlo?",
      answer:
    ...
    },
    {
      id: "q21",
      category: "Formatos de datos",
      question: "¿Qué es JSON Schema y por qué debería usarlo?",
      answer:
    ...
    },
    {
      id: "q22",
      category: "Formatos de datos",
      question: "¿Cómo comparo dos archivos de texto para ver diferencias?",
      answer:
    ...
    },
    {
      id: "q23",
      category: "Red y web",
      question: "¿Cómo funcionan las subredes CIDR y los rangos IP?",
      answer:
    ...
    },
    {
      id: "q24",
      category: "Red y web",
      question: "¿Qué información contiene una cadena User-Agent?",
      answer:
    ...
    },
    {
      id: "q25",
      category: "Red y web",
      question: "¿Cómo uso cURL para depurar APIs?",
      answer:
    ...
    },
    {
      id: "q26",
      category: "Red y web",
      question: "¿Qué es SAML y cómo funciona el SSO?",
      answer:
    ...
    },
    {
      id: "q27",
      category: "Red y web",
      question: "¿Qué son SPF, DKIM y DMARC en la seguridad del correo?",
      answer:
    ...
    {
      id: "q28",
      category: "Productividad para desarrolladores",
      question: "¿Cómo estimo el coste de tokens de una API para LLMs?",
      answer:
    ...
    },
    {
      id: "q29",
      category: "Productividad para desarrolladores",
      question: "¿Qué es una expresión cron y cómo se escribe?",
      answer:
    ...
    },
    {
      id: "q30",
      category: "Productividad para desarrolladores",
      question: "¿Cómo creo buenas plantillas de prompts para IA?",
      answer:
  ...
  "zh-CN": [
    {
      id: "q1",
      category: "常规",
      question: "SimpleTool 是什么，适合哪些用户？",
      answer:
    ...
    },
    {
      ...
      category: "常规",
      question: "需要注册账号吗？",
      answer: "不需要。无需注册或登录，打开工具即可直接使用。",
    },
    {
      id: "q4",
      category: "常规",
      question: "我的数据安全吗？客户端处理是怎么工作的？",
      answer:
    ...
    },
    {
      id: "q8",
      category: "安全与密码学",
      question: "MD5、SHA-256 和 SHA-512 有什么区别？",
      answer:
    ...
    },
    {
      id: "q11",
      category: "安全与密码学",
      question: "密码哈希中 bcrypt 和 Argon2 有何区别？",
      answer:
    ...
    },
    {
      id: "q21",
      category: "数据格式",
      question: "JSON Schema 是什么，为什么要使用它？",
      answer:
    ...
    },
    {
      id: "q27",
      category: "网络与 Web",
      question: "邮件安全中的 SPF、DKIM 和 DMARC 是什么？",
      answer:
    ...
    },
    {
      id: "q28",
      category: "开发者效率",
      question: "如何估算 LLM 的 API token 费用？",
      answer:
  ...
  "zh-TW": [
    {
      id: "q1",
      category: "一般",
      question: "SimpleTool 是什麼，適合哪些使用者？",
      answer:
    ...
    },
    {
      ...
      category: "一般",
      question: "需要建立帳號嗎？",
      answer: "不需要。無需註冊或登入，開啟工具即可直接使用。",
    },
    {
      id: "q4",
      category: "一般",
      question: "我的資料安全嗎？用戶端處理是如何運作的？",
      answer:
    ...
    },
    {
      id: "q8",
      category: "安全性與密碼學",
      question: "MD5、SHA-256 和 SHA-512 有什麼差異？",
      answer:
    ...
    },
    {
      id: "q11",
      category: "安全性與密碼學",
      question: "密碼雜湊中 bcrypt 和 Argon2 有何差異？",
      answer:
    ...
    },
    {
      id: "q21",
      category: "資料格式",
      question: "JSON Schema 是什麼，為什麼要使用它？",
      answer:
    ...
    },
    {
      id: "q23",
      category: "網路與 Web",
      question: "CIDR 子網路和 IP 範圍是如何運作的？",
      answer:
    ...
    },
    {
      id: "q27",
      category: "網路與 Web",
      question: "電子郵件安全中的 SPF、DKIM 和 DMARC 是什麼？",
      answer:
    ...
    },
    {
      id: "q28",
      category: "開發者生產力",
      question: "如何估算 LLM 的 API token 費用？",
      answer:
  ...
  fr: [
    {
      id: "q1",
      category: "Général",
      question: "Qu'est-ce que SimpleTool et à qui s'adresse-t-il ?",
      answer:
    ...
    },
    {
      id: "q2",
      category: "Général",
      question: "SimpleTool est-il vraiment gratuit ?",
      answer:
    ...
    },
    {
      id: "q6",
      category: "Général",
      question: "Puis-je utiliser SimpleTool hors ligne ?",
      answer:
    ...
    },
    {
      ...
      question: "Qu'est-ce qui rend un mot de passe vraiment sécurisé ?",
      answer:
    ...
    },
    {
      id: "q8",
      category: "Sécurité et cryptographie",
      question: "Quelle est la différence entre MD5, SHA-256 et SHA-512 ?",
      answer:
    ...
    },
    {
      id: "q9",
      category: "Sécurité et cryptographie",
      question: "Pourquoi MD5 est-il considéré comme cassé ?",
      answer:
    ...
    },
    {
      id: "q10",
      category: "Sécurité et cryptographie",
      question: "Qu'est-ce que HMAC et quand l'utiliser ?",
      answer:
    ...
    },
    {
      id: "q12",
      category: "Sécurité et cryptographie",
      question: "Qu'est-ce qu'un JWT et quand l'utiliser ?",
      answer:
    ...
    },
    {
      ...
      question: "Quelle est la différence entre JSON et YAML ?",
      answer:
    ...
    },
    {
      id: "q16",
      category: "Formats de données",
      question: "Comment valider du JSON ?",
      answer:
    ...
    },
    {
      id: "q17",
      category: "Formats de données",
      question: "Qu'est-ce que l'encodage Base64 et quand est-il utilisé ?",
      answer:
    ...
    },
    {
      id: "q19",
      category: "Formats de données",
      question: "Comment convertir entre différents formats de timestamp ?",
      answer:
    ...
    },
    {
      id: "q20",
      category: "Formats de données",
      question: "Qu'est-ce qu'un UUID et quand l'utiliser ?",
      answer:
    ...
    },
    {
      id: "q21",
      category: "Formats de données",
      question: "Qu'est-ce que JSON Schema et pourquoi l'utiliser ?",
      answer:
    ...
    {
      id: "q23",
      category: "Réseau et Web",
      question: "Comment fonctionnent les sous-réseaux CIDR et les plages IP ?",
      answer:
    ...
    },
    {
      id: "q24",
      category: "Réseau et Web",
      question: "Quelles informations contient une chaîne User-Agent ?",
      answer:
    ...
    },
    {
      id: "q25",
      category: "Réseau et Web",
      question: "Comment utiliser cURL pour déboguer des API ?",
      answer:
    ...
    },
    {
      id: "q26",
      category: "Réseau et Web",
      question: "Qu'est-ce que SAML et comment fonctionne le SSO ?",
      answer:
    ...
    },
    {
      id: "q27",
      category: "Réseau et Web",
      question: "Que sont SPF, DKIM et DMARC dans la sécurité des e-mails ?",
      answer:
    ...
    {
      id: "q28",
      category: "Productivité développeur",
      question: "Comment estimer les coûts en tokens d'API pour les LLM ?",
      answer:
    ...
    },
    {
      id: "q29",
      category: "Productivité développeur",
      question: "Qu'est-ce qu'une expression cron et comment en écrire une ?",
      answer:
    ...
    },
    {
      id: "q30",
      category: "Productivité développeur",
      question: "Comment créer des templates de prompts efficaces pour l'IA ?",
      answer:
  ...
  de: [
    {
      id: "q1",
      category: "Allgemein",
      question: "Was ist SimpleTool und für wen ist es gedacht?",
      answer:
    ...
    },
    {
      id: "q2",
      category: "Allgemein",
      question: "Ist SimpleTool wirklich kostenlos?",
      answer:
    ...
    },
    {
      id: "q6",
      category: "Allgemein",
      question: "Kann ich SimpleTool offline nutzen?",
      answer:
    ...
    {
      id: "q7",
      category: "Sicherheit und Kryptographie",
      question: "Was macht ein Passwort wirklich sicher?",
      answer:
    ...
    },
    {
      id: "q8",
      category: "Sicherheit und Kryptographie",
      question: "Was ist der Unterschied zwischen MD5, SHA-256 und SHA-512?",
      answer:
    ...
    },
    {
      id: "q9",
      category: "Sicherheit und Kryptographie",
      question: "Warum gilt MD5 als gebrochen?",
      answer:
    ...
    },
    {
      id: "q10",
      category: "Sicherheit und Kryptographie",
      question: "Was ist HMAC und wann sollte ich es verwenden?",
      answer:
    ...
    },
    {
      id: "q12",
      category: "Sicherheit und Kryptographie",
      question: "Was ist ein JWT und wann sollte ich es verwenden?",
      answer:
    ...
    },
    {
      ...
      question: "Was ist der Unterschied zwischen JSON und YAML?",
      answer:
    ...
    },
    {
      id: "q16",
      category: "Datenformate",
      question: "Wie validiere ich JSON?",
      answer:
    ...
    },
    {
      id: "q17",
      category: "Datenformate",
      question: "Was ist Base64-Kodierung und wann wird sie verwendet?",
      answer:
    ...
    },
    {
      id: "q20",
      category: "Datenformate",
      question: "Was ist eine UUID und wann sollte ich sie verwenden?",
      answer:
    ...
    },
    {
      id: "q22",
      category: "Datenformate",
      question: "Wie vergleiche ich zwei Textdateien auf Unterschiede?",
      answer:
    ...
    {
      id: "q23",
      category: "Netzwerk und Web",
      question: "Wie funktionieren CIDR-Subnetze und IP-Bereiche?",
      answer:
    ...
    },
    {
      id: "q24",
      category: "Netzwerk und Web",
      question: "Welche Informationen enthält ein User-Agent-String?",
      answer:
    ...
    },
    {
      id: "q25",
      category: "Netzwerk und Web",
      question: "Wie verwende ich cURL zum Debuggen von APIs?",
      answer:
    ...
    },
    {
      id: "q26",
      category: "Netzwerk und Web",
      question: "Was ist SAML und wie funktioniert SSO?",
      answer:
    ...
    },
    {
      id: "q27",
      category: "Netzwerk und Web",
      question: "Was sind SPF, DKIM und DMARC in der E-Mail-Sicherheit?",
      answer:
    ...
    {
      id: "q28",
      category: "Entwicklerproduktivität",
      question: "Wie schätze ich API-Token-Kosten für LLMs?",
      answer:
    ...
    },
    {
      id: "q29",
      category: "Entwicklerproduktivität",
      question: "Was ist ein Cron-Ausdruck und wie schreibt man einen?",
      answer:
    ...
    },
    {
      id: "q30",
      category: "Entwicklerproduktivität",
      question: "Wie erstelle ich effektive Prompt-Templates für KI?",
      answer:
  ...
  pt: [
    {
      id: "q1",
      category: "Geral",
      question: "O que é o SimpleTool e para quem é indicado?",
      answer:
    ...
    },
    {
      id: "q2",
      category: "Geral",
      question: "O SimpleTool é realmente gratuito?",
      answer:
    ...
    },
    {
      id: "q6",
      category: "Geral",
      question: "Posso usar o SimpleTool offline?",
      answer:
    ...
    },
    {
      ...
      question: "O que torna uma senha verdadeiramente segura?",
      answer:
    ...
    },
    {
      id: "q8",
      category: "Segurança e Criptografia",
      question: "Qual é a diferença entre MD5, SHA-256 e SHA-512?",
      answer:
    ...
    },
    {
      id: "q9",
      category: "Segurança e Criptografia",
      question: "Por que o MD5 é considerado quebrado?",
      answer:
    ...
    },
    {
      id: "q10",
      category: "Segurança e Criptografia",
      question: "O que é HMAC e quando devo usá-lo?",
      answer:
    ...
    },
    {
      id: "q11",
      category: "Segurança e Criptografia",
      question: "Como o bcrypt se compara ao Argon2 para hashing de senhas?",
      answer:
    ...
    },
    {
      id: "q12",
      category: "Segurança e Criptografia",
      question: "O que é um JWT e quando devo usá-lo?",
      answer:
    ...
    },
    {
      id: "q14",
      category: "Segurança e Criptografia",
      question: "O que é Content Security Policy (CSP) e por que ela importa?",
      answer:
    ...
    {
      id: "q15",
      category: "Formatos de Dados",
      question: "Qual é a diferença entre JSON e YAML?",
      answer:
    ...
    },
    {
      id: "q17",
      category: "Formatos de Dados",
      question: "O que é codificação Base64 e quando é usada?",
      answer:
    ...
    },
    {
      id: "q19",
      category: "Formatos de Dados",
      question: "Como converter entre diferentes formatos de timestamp?",
      answer:
    ...
    },
    {
      id: "q20",
      category: "Formatos de Dados",
      question: "O que é um UUID e quando devo usá-lo?",
      answer:
    ...
    {
      id: "q23",
      category: "Redes e Web",
      question: "Como funcionam sub-redes CIDR e intervalos de IP?",
      answer:
    ...
    },
    {
      id: "q24",
      category: "Redes e Web",
      question: "Que informações uma string User-Agent contém?",
      answer:
    ...
    },
    {
      id: "q25",
      category: "Redes e Web",
      question: "Como usar cURL para depurar APIs?",
      answer:
    ...
    },
    {
      id: "q26",
      category: "Redes e Web",
      question: "O que é SAML e como funciona o SSO?",
      answer:
    ...
    },
    {
      id: "q27",
      category: "Redes e Web",
      question: "O que são SPF, DKIM e DMARC na segurança de e-mail?",
      answer:
    ...
    {
      id: "q28",
      category: "Produtividade do Desenvolvedor",
      question: "Como estimo os custos de tokens de API para LLMs?",
      answer:
    ...
    },
    {
      id: "q29",
      category: "Produtividade do Desenvolvedor",
      question: "O que é uma expressão cron e como escrever uma?",
      answer:
    ...
    },
    {
      id: "q30",
      category: "Produtividade do Desenvolvedor",
      question: "Como criar templates de prompt eficazes para IA?",
      answer:
  ...
  vi: [
    {
      id: "q1",
      category: "Chung",
      question: "SimpleTool là gì và dành cho ai?",
      answer:
    ...
    },
    {
      id: "q2",
      category: "Chung",
      question: "SimpleTool có thực sự miễn phí không?",
      answer:
    ...
    },
    {
      id: "q6",
      category: "Chung",
      question: "Tôi có thể dùng SimpleTool ngoại tuyến không?",
      answer:
    ...
    {
      id: "q7",
      category: "Bảo mật & Mật mã",
      question: "Điều gì làm cho một mật khẩu thực sự an toàn?",
      answer:
    ...
    },
    {
      id: "q8",
      category: "Bảo mật & Mật mã",
      question: "Sự khác biệt giữa MD5, SHA-256 và SHA-512 là gì?",
      answer:
    ...
    },
    {
      id: "q9",
      category: "Bảo mật & Mật mã",
      question: "Tại sao MD5 được coi là đã bị phá vỡ?",
      answer:
    ...
    },
    {
      id: "q10",
      category: "Bảo mật & Mật mã",
      question: "HMAC là gì và khi nào nên sử dụng nó?",
      answer:
    ...
    },
    {
      id: "q12",
      category: "Bảo mật & Mật mã",
      question: "JWT là gì và khi nào nên sử dụng?",
      answer:
    ...
    },
    {
      id: "q14",
      category: "Bảo mật & Mật mã",
      question: "Content Security Policy (CSP) là gì và tại sao quan trọng?",
      answer:
    ...
    {
      id: "q15",
      category: "Định dạng Dữ liệu",
      question: "Sự khác biệt giữa JSON và YAML là gì?",
      answer:
    ...
    },
    {
      id: "q16",
      category: "Định dạng Dữ liệu",
      question: "Làm cách nào để kiểm tra tính hợp lệ của JSON?",
      answer:
    ...
    },
    {
      id: "q17",
      category: "Định dạng Dữ liệu",
      question: "Mã hóa Base64 là gì và khi nào được sử dụng?",
      answer:
    ...
    },
    {
      id: "q18",
      category: "Định dạng Dữ liệu",
      question: "Biểu thức chính quy là gì và tại sao hữu ích?",
      answer:
    ...
    },
    {
      id: "q20",
      category: "Định dạng Dữ liệu",
      question: "UUID là gì và khi nào nên sử dụng?",
      answer:
    ...
    },
    {
      id: "q21",
      category: "Định dạng Dữ liệu",
      question: "JSON Schema là gì và tại sao nên sử dụng?",
      answer:
    ...
    },
    {
      id: "q22",
      category: "Định dạng Dữ liệu",
      question: "Làm cách nào so sánh sự khác biệt giữa hai tệp văn bản?",
      answer:
    ...
    },
    {
      id: "q23",
      category: "Mạng & Web",
      question: "Mạng con CIDR và dải IP hoạt động như thế nào?",
      answer:
    ...
    },
    {
      id: "q24",
      category: "Mạng & Web",
      question: "Chuỗi User-Agent chứa thông tin gì?",
      answer:
    ...
    },
    {
      id: "q25",
      category: "Mạng & Web",
      question: "Làm cách nào dùng cURL để gỡ lỗi API?",
      answer:
    ...
    },
    {
      id: "q26",
      category: "Mạng & Web",
      question: "SAML là gì và SSO hoạt động như thế nào?",
      answer:
    ...
    },
    {
      id: "q27",
      category: "Mạng & Web",
      question: "SPF, DKIM và DMARC trong bảo mật email là gì?",
      answer:
    ...
    {
      id: "q28",
      category: "Năng suất Lập trình viên",
      question: "Làm cách nào ước tính chi phí token API cho LLM?",
      answer:
    ...
    },
    {
      id: "q29",
      category: "Năng suất Lập trình viên",
      question: "Biểu thức cron là gì và cách viết?",
      answer:
    ...
    },
    {
      id: "q30",
      category: "Năng suất Lập trình viên",
      question: "Làm cách nào tạo template prompt hiệu quả cho AI?",
      answer:
