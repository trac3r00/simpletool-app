...
export const roulettePresets = {
  default_options: {
    ...
    segments: [
      {
        id: "option-1",
        labelKey: "tools.roulette-wheel.ui.presetOptionOne",
        fallbackLabel: "Option 1",
        weight: 1,
      },
      {
        id: "option-2",
        labelKey: "tools.roulette-wheel.ui.presetOptionTwo",
        fallbackLabel: "Option 2",
        weight: 1,
      },
      {
        id: "option-3",
        labelKey: "tools.roulette-wheel.ui.presetOptionThree",
        fallbackLabel: "Option 3",
        weight: 1,
      },
      {
        id: "option-4",
        labelKey: "tools.roulette-wheel.ui.presetOptionFour",
        fallbackLabel: "Option 4",
        weight: 1,
      },
    ],
  },
  yes_no_maybe: {
    ...
    segments: [
      {
        id: "yes",
        labelKey: "tools.roulette-wheel.ui.presetOptionYes",
        fallbackLabel: "Yes",
        weight: 1,
      },
      {
        id: "no",
        labelKey: "tools.roulette-wheel.ui.presetOptionNo",
        fallbackLabel: "No",
        weight: 1,
      },
      {
        id: "maybe",
        labelKey: "tools.roulette-wheel.ui.presetOptionMaybe",
        fallbackLabel: "Maybe",
        weight: 1,
      },
    ],
  ...
  lunch_vote: {
    ...
    segments: [
      {
        id: "ramen",
        labelKey: "tools.roulette-wheel.ui.presetOptionRamen",
        fallbackLabel: "Ramen",
        weight: 2,
      },
      {
        id: "pizza",
        labelKey: "tools.roulette-wheel.ui.presetOptionPizza",
        fallbackLabel: "Pizza",
        weight: 2,
      },
      {
        id: "tacos",
        labelKey: "tools.roulette-wheel.ui.presetOptionTacos",
        fallbackLabel: "Tacos",
        weight: 1,
      },
      {
        id: "salad",
        labelKey: "tools.roulette-wheel.ui.presetOptionSalad",
        fallbackLabel: "Salad",
        weight: 1,
      },
    ],
  ...
  team_shuffle: {
    ...
    segments: [
      {
        id: "team-red",
        labelKey: "tools.roulette-wheel.ui.presetOptionTeamRed",
        fallbackLabel: "Team Red",
        weight: 1,
      },
      {
        id: "team-blue",
        labelKey: "tools.roulette-wheel.ui.presetOptionTeamBlue",
        fallbackLabel: "Team Blue",
        weight: 1,
      },
      {
        id: "team-green",
        labelKey: "tools.roulette-wheel.ui.presetOptionTeamGreen",
        fallbackLabel: "Team Green",
        weight: 1,
      },
      {
        id: "team-gold",
        labelKey: "tools.roulette-wheel.ui.presetOptionTeamGold",
        fallbackLabel: "Team Gold",
        weight: 1,
      },
    ],
  },
...
export function getRouletteBootConfig() {
  return {
    ...
    sections: rouletteCatalog.sections.map((id) => ({
      ...rouletteSectionMeta[id],
    })),
