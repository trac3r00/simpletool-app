...
test.describe("OG image meta and asset", () => {
  test("/og-image.png returns 200 with image/* content-type", async ({
    request,
  }) => {
  ...
  test("home page og:image meta resolves to a 200 image URL", async ({
    page,
    request,
  }) => {
    await page.goto("/");
  ...
  test("json-formatter page og:image meta resolves to a 200 image URL", async ({
    page,
    request,
  }) => {
