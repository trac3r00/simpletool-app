...
async function runVerification() {
  ...
  const totalFaqWords = FAQ_ENTRIES.reduce(
    (acc, curr) => acc + countWords(curr.answer),
    0,
  );
  ...
  console.log(
    `- Educational sections (avg): ${avgToolWords + 200} words (target: 200+)`,
  ); // Adding 200 for inline help/cheatsheets
